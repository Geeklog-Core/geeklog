...
$_FM_CONF = array(
    ...
    'options'         => array(
        ...
        'cacheThumbnails'    => true,           // since GL-2.1.2
        'searchBox'          => true,
        'listFiles'          => true,
        'fileSorting'        => 'default',
        'quickSelect'        => false,          // since GL-2.1.2
        'chars_only_latin'   => true,
        'splitterWidth'      => 200,            // since GL-2.1.2
        'splitterMinWidth'   => 200,            // since GL-2.1.2
...
$path = $_CONF['path_html'] . 'filemanager/scripts/filemanager.config.json';
