...
if (DB_count($_TABLES['users'],'username','NewAdmin') > 0) {
    ...
    $display .= "Installation of Geeklog $VERSION complete! Click <a href=\"{$_CONF['site_url']}i\">here</a> to see your new Geeklog site! <font color=\"red\"><b>WARNING:</b></font>Before you do anything else you need to make sure that {$_CONF['path_html']}admin/install/install.php can not be executed by the webserver otherwise someone could do damage to your new Geeklog installation.  Either change the file permissions so it can't be executed OR move the file someplace outside your web tree.";
}
