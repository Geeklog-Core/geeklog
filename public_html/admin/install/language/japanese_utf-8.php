...
$LANG_ERROR = array(
    ...
    27 => 'The Google+ OAuth login method has been removed from Geeklog since the <a href="https://support.google.com/plus/answer/9195133" target="_blank">Google+ service shut down on April 2, 2019</a>. All users who used Google+ to log into Geeklog will now have their accounts locked (since the login method doesn\'t work anymore).<br><br>As of Geeklog v2.2.1, it does now offer the option to convert remote accounts to local accounts. If you have any Google+ accounts (or any other remote accounts) you want to convert, edit the user account from the User Manager and then check off the "convert from remote to a local account" option and click on save. At this point the account will be converted to a local account and a random password will be generated. If the account has an email address and the status has been set to "Active" an email will be automatically sent to the user about how to access his account. If not then you will manually have to fill in this information and let the user know how he can access his local account.',
