...
$LANG_SUCCESS = array(
    ...
    4 => ' Geeklog. אנא קחו רגע לקרוא את המידע המצוין להלן.',
...
$LANG_HELP = array(
    ...
    3 => 'Geeklog יכול להיות מותקן בעזרת שימוש ב-MySQL או Microsoft SQL database. אם אינכם בטוחים איזו אופצייה לבחור עליכם ליצור קשר עם מארחי השרת שלכם.<br><br><strong>שימו לב:</strong> טבלאות InnoDB עשויות לשפר את הביצועים באתרים (מאוד) גדולים, אך גם להפוך את גיבויי מאגר המידע ליותר מסובכים.',
