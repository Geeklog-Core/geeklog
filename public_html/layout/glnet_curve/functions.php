 ...
 */
function theme_config_glnet_curve()
{
    $options = array(
		...
		// Turn this off since resource class now minifies stuff
 ...
 */
function theme_css_glnet_curve()
{
    global $_CONF, $LANG_DIRECTION;

    $theme_var = theme_config_glnet_curve();
 ...
 */
function theme_js_libs_glnet_curve()
{
    $theme_var = theme_config_glnet_curve();
 ...
 */
function theme_js_files_glnet_curve()
{
    $theme_var = theme_config_glnet_curve();
 ...
 */
function theme_init_glnet_curve()
{
 ...
 */
function theme_getThemeItem_glnet_curve($item)
{
    $retval = '';
