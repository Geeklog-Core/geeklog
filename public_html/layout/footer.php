...
<tr><td bgcolor=EEEEEE colspan=2><img src=<?php echo $CONF["site_url"]; ?>/images/speck.gif width=1 height=1></td></tr>
<tr bgcolor=DDDDDD valign=top><td height=20 class=footer>&nbsp;Copyright &copy; 2000 <?php echo $CONF["site_name"];?><br>
