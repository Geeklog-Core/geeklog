 ...
 *
 *  May 29/2005: Modified by Blaine Lang for Geeklog Integration
...
$fckphp_config['basedir'] = $_CONF['path_html'] ;
/*==============================================================================*/
...
/*------------------------------------------------------------------------------*/
$fckphp_config['UserFilesPath'] = $_CONF_FCK['imagelibrary'] ;
/*==============================================================================*/
...
$fckphp_config['DebugOutput'] = $_CONF['path_log'] . "fck.dbg";
