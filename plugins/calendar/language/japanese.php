...
$LANG_CAL_1 = array(
    ...
    6 => 'イベントの追加',
    7 => 'これからのイベント',
    8 => '個人カレンダーにこのイベントを追加すると、「個人カレンダー」をユーザ管理メニューから選択することで見ることができます。',
    9 => '個人カレンダーに追加',
    10 => '個人カレンダーから削除',
    ...
    25 => '-',
    26 => 'イベントを投稿',
    27 => "{$_CONF['site_name']}にイベントを投稿すると、サイト全体のカレンダーに登録されます。<br>全体カレンダーのイベントは、各ユーザが必要に応じて個人カレンダーに登録できます。",
    28 => 'タイトル',
    29 => '終了日時',
    30 => '開始日時',
    31 => '終日のイベント',
    ...
    47 => 'イベント上位10件',
    48 => '閲覧数',
    49 => 'このサイトにはイベントがないか、誰もイベントをクリックしていないかのどちらかのようです。',
    50 => 'イベント',
    51 => '削除'
);
...
$LANG_CAL_ADMIN = array(
    ...
    21 => 'キャンセル',
    22 => '削除',
    23 => '開始日時をただしく指定してください。',
    24 => '終了日時をただしく指定してください。',
    25 => '終了日時をただしく指定してください。'
);
...
$LANG_CAL_MESSAGE = array(
    ...
    'noprivate' => '申し訳ありませんが、このサイトでは、個人カレンダーが無効です。',
    'unauth'    => '申し訳ありませんが、イベント管理ページにアクセスする権限がありません。このアクセスは記録させていただきましたのでご了承ください。',
);

$PLG_calendar_MESSAGE4  = "{$_CONF['site_name']}にイベントを投稿していただき、ありがとうございます。スタッフに送信され、承認待ちの状態になっています。承認された場合、このサイトの<a href=\"{$_CONF['site_url']}/calendar/index.php\">カレンダー</a>セクションに表示されます。";
