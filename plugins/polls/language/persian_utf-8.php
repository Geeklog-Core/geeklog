...
$LANG_configsections['polls'] = [
    'label' => 'نظرسنجی ها',
    'title' => 'پیکربندی نظرسنجی ها'
];

$LANG_confignames['polls'] = [
...
$LANG_configselects['polls'] = [
    0  => ['True' => 1, 'False' => 0],
    1  => ['True' => true, 'False' => false],
    2  => ['As Submitted' => 'submitorder', 'By Votes' => 'voteorder'],
    5  => ['Hide' => 'hide', 'Show - Use Modified Date' => 'modified', 'Show - Use Created Date' => 'created'],
    9  => ['Forward to Poll' => 'item', 'Display Admin List' => 'list', 'Display Public List' => 'plugin', 'Display Home' => 'home', 'Display Admin' => 'admin'],
