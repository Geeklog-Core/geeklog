...
$LANG_configsections['staticpages'] = [
    'label' => 'Static Pages',
    'title' => 'Static Pages Configuration'
];

$LANG_confignames['staticpages'] = [
    'allow_php'                              => 'Allow PHP?',
...
$LANG_configsubgroups['staticpages'] = [
    'sg_main' => 'Main Settings'
];

$LANG_tab['staticpages'] = [
...
$LANG_configselects['staticpages'] = [
    0  => ['True' => 1, 'False' => 0],
    1  => ['True' => true, 'False' => false],
    2  => ['Date' => 'date', 'Page ID' => 'id', 'Title' => 'title'],
    3  => ['Date' => 'date', 'Page ID' => 'id', 'Title' => 'title', 'Label' => 'label'],
    4  => ['Date' => 'date', 'Page ID' => 'id', 'Title' => 'title', 'Author' => 'author'],
