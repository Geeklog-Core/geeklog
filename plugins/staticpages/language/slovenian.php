...
$LANG_STATIC = array(
    ...
    'label' => 'Nalepka',
    'nopages' => 'V sistemu še ni statienih strani',
    'save' => 'shrani',
    'preview' => 'predogled',
    'delete' => 'izbriši',
    'cancel' => 'prekliei',
    'access_denied' => 'Dostop zavrnjen',
    'access_denied_msg' => 'Nedovoljeno poskušaš dostopiti do ene od skrbniških statienih strani. Vsi poskusi nedovoljenega dostopa na se beležijo.',
    ...
    'php_msg' => 'PHP: ',
    'php_warn' => 'Opozorilo: Koda PHP na tvoji strani bo procesirana, ee omogoeiš to možnost. Uporabljaj previdno!',
    ...
    'stats_headline' => 'Najboljših 10 statienih strani',
    'stats_page_title' => 'Naslov strani',
    'stats_hits' => 'Zadetki',
    'stats_no_hits' => 'Izgleda, da na tem mestu ni statienih strani ali pa še nikoli ni nihee nobene pogledal.',
    'id' => 'ID',
    'duplicate_id' => 'Za to statieno stran izbrani ID je že v rabi. Izberi prosim drug ID.',
    'instructions' => 'Za spreminjanje ali izbris statiene strani klikni na njeno ikono za urejanje spodaj. Za ogled statiene strani klikni na naslov tiste, ki jo hoeeš pogledati. Za ustvarjenje nove statiene strani klikni na "Ustvari novo" zgoraj. Za ustvarjenje kopije že obstojeee statiene strani klikni na ikono za kopiranje.',
    'centerblock' => 'Osrednji blok: ',
    'centerblock_msg' => 'Ee potrdiš, bo ta statiena stran prikazana kot osrednji blok na glavni strani.',
    'topic' => 'Rubrika: ',
    'position' => 'Položaj: ',
    'all_topics' => 'Vse',
    ...
    'inblock_msg' => 'V bloku: ',
    'inblock_info' => 'Ee potrdiš, bo ta statiena stran prikazana v okvirju (bloku).',
...
$PLG_staticpages_MESSAGE21 = 'Ta stran še ne obstaja. Za ustvarjenje strani prosim izpolni spodnji formular. Ee si tu po pomoti, klikni gumb Prekliei/Cancel.';
...
$LANG_fs['staticpages'] = array(
    'fs_main' => 'Splošne nastavitve statienih strani',
