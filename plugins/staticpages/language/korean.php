...
$LANG_STATIC = array(
    ...
    'staticpageeditor' => 'Á¤Àû ÆäÀÌÁöÀÇ ÆíÁý',
    'writtenby' => '¼ÒÀ¯ÀÚ',
    'date' => 'ÃÖÁ¾°»½ÅÀÏ',
    'title' => 'Á¦¸ñ',
    ...
    'leftblocks' => '¿ÞÆíºí·Î±× ÀÖ½À´Ï´Ù(¿À¸¥Æíºí·Î±×´Â ¾ø½À´Ï´Ù)',
    'addtomenu' => '¿ÞÆíºí·Î±× ¸Þ´º¿¡ Ãß°¡',
    'label' => '¸Þ´ºÀÌ¸§',
    ...
    'access_denied_msg' => 'Ã¼Å©¸¦ ÇÏ¸é Á¢¼Ó±ÇÇÑÀÌ ¾ø´Â °æ¿ì, È­¸éÀÌ ·Î±×ÀÎ È­¸éÀ¸·Î ÀÚµ¿ÀûÀ¸·Î Ç¥½ÃµË´Ï´Ù.  Ã¼Å©¸¦ ÇÏÁö ¾Ê´Â °æ¿ì¿¡´Â ¡¸°ü¸®±ÇÇÑÀÌ ¾ø½À´Ï´Ù¡¹¶ó´Â ¸Þ¼¼Áö°¡ Ç¥½Ã µË´Ï´Ù',
    'all_html_allowed' => '¸ðµç HTML À» ÀÌ¿ë ÇÒ ¼ö ÀÖ½À´Ï´Ù',
    'results' => 'Á¤Àû ÆäÀÌÁö °Ë»ö°á°ú',
    'author' => '¼ÒÀ¯ÀÚ',
    'no_title_or_content' => ' <b> Á¦¸ñ</b> ¿Í  <b> ³»¿ë</b> ¸¦ Àû¾îÁÖ½Ã±â ¹Ù¶ø´Ï´Ù.',
    'no_such_page_anon' => '·Î±×ÀÎ ÇÏ½Ã±â ¹Ù¶ø´Ï´Ù.',
    'no_page_access_msg' => "ÀÌ ¹®Á¦´Â ¾ÆÁ÷ ·Î±×ÀÎ ÇÏÁö ¾Ê¾Ò°Å³ª ¾Æ¸¶µµ ÀÌ »çÀÌÆ® {$_CONF['site_name']} ÀÇ È¸¿øÀÌ ¾Æ´Ï±â ¶§¹®ÀÎ °ÍÀ¸·Î ¿©°ÜÁý´Ï´Ù.  {$_CONF['site_name']} ¿¡ <a href=\"{$_CONF['site_url']}/users.php?mode=new\"> È¸¿øµî·Ï</a>À» ÇÏ½Ã°Å³ª, ÀûÀýÇÑ Á¢¼Ó±ÇÀ» °ü¸®ÀÚ·Î ºÎÅÍ ÃëµæÇÏ½Ã±â ¹Ù¶ø´Ï´Ù",
    'php_msg' => 'PHP: ',
    'php_warn' => '<br' . XHTML . '>ÁÖÀÇ: ÀÌ ¿É¼ÇÀÌ À¯È¿ÇÏ±â µÇ¸é ´ç½ÅÀÇ ÆäÀÌÁö¿¡ µé¾îÀÖ´Â PHP ÄÚµå°¡ ½ÇÇàµË´Ï´Ù.  Á¤Àû ÆäÀÌÁö¸¦ ÀÌ¿ëÇÏ´Â °æ¿ì¿¡´Â ´Ù½ÃÇÑ¹ø °ü¸®È­¸é ¡¸±×·ì:Static Page Admin¡¹¿¡¼­ ±ÇÇÑ¡¸Staticpages. PHP¡¹ ¿¡ Ã¼Å©ÇÏ½Ã±â ¹Ù¶ø´Ï´Ù.  PHP¸¦ »ç¿ëÇÏ´Â °æ¿ì Åë»ó(return) ¾øÀÌ ±×´ë·Î ¡¸PHP ½ÇÇàÇÏ±â¡¹ ¸ðµå¿¡¼­ ÀÌ¿ëÇÒ ¼ö ÀÖ½À´Ï´Ù.  ÀÌ¿ë¿¡´Â ¼¼½ÉÇÑ ÁÖÀÇ¸¦ ±â¿ïÀÌ½Ã±â ¹Ù¶ø´Ï´Ù !!',
    'exit_msg' => 'Á¶È¸±ÇÇÑÀÌ ¾ø´Â °æ¿ì: ',
    'exit_info' => 'Ã¼Å©¸¦ ÇÏ¸é Á¶È¸±ÇÇÑÀÌ ¾ø´Â °æ¿ì, ·Î±×ÀÎ ¿ä±¸È­¸éÀÌ Ç¥½ÃµË´Ï´Ù. Ã¼Å©¸¦ ÇÏÁö ¾Ê´Â °æ¿ì¿¡´Â ¡¸±ÇÇÑÀÌ ¾ø½À´Ï´Ù¡¹ ¶ó´Â ¸Þ¼¼Áö°¡ Ç¥½ÃµË´Ï´Ù.',
    'deny_msg' => 'ÆäÀÌÁö Á¢¼Ó¿¡ ½ÇÆÐ ÇÏ¿´½À´Ï´Ù.  ÆäÀÌÁö°¡ ÀÌµ¿ È¤Àº »èÁ¦µÇ°Å³ª, ¾Æ´Ï¸é ±ÇÇÑÀÌ ¾ø°Å³ª ¾î´À ÇÑ ÂÊÀÏ °ÍÀÔ´Ï´Ù.',
    ...
    'instructions' => 'ÆäÀÌÁö¸¦ ÆíÁý, »èÁ¦´Â °¢ ÆäÀÌÁö ¸Ó¸®ºÎºÐÀÇ ÆíÁý¾ÆÀÌÄÜÀ» Å¬¸¯.  ÆäÀÌÁö Á¶È¸´Â Á¦¸ñÀ» Å¬¸¯, »õ·Î¿î ÆäÀÌÁö¸¦ ÀÛ¼º ÇÒ °æ¿ì¿¡´Â ¡¸½Å±ÔÀÛ¼º¡¹¸µÅ©¸¦ Å¬¸¯. ÆäÀÌÁö º¹»ç´Â ¡¸C¡¹¸¦ Å¬¸¯ ÇÏ½Ã±â ¹Ù¶ø´Ï´Ù.',
    'centerblock' => 'Áß½É¿µ¿ª Ç¥½Ã: ',
    'centerblock_msg' => 'Ã¼Å©¸¦ ÇÏ¸é Ã³À½ÆäÀÌÁö È¤Àº È­Á¦ÀÇ ¸Ó¸® ÆäÀÌÁö Áß½É¿µ¿ª¿¡ Ç¥½ÃµË´Ï´Ù. Ç¥½Ã´Â ID·Î ºÐ·ù µË´Ï´Ù.',
    'topic' => 'ÅäÇÈ: ',
    'position' => 'Ç¥½ÃÀå¼Ò: ',
    'all_topics' => 'ÀüºÎ',
    'no_topic' => 'È¨ÆäÀÌÁö¸¸',
    'position_top' => 'ÆäÀÌÁö ¸Ó¸´ºÎºÐ',
    'position_feat' => 'ÁÖ¸ñ±â»ç ¾Æ·§ºÎºÐ',
    ...
    'centerblock_bottom' => '¾Æ·§ºÎºÐ',
    'centerblock_entire' => 'ÆäÀÌÁö ÀüÃ¼',
    'inblock_msg' => 'ºí·Î±×·Î µÑ·¯½×ÀÓ: ',
    'inblock_info' => 'Ã¼Å©¸¦ ÇÏ¸é Á¦¸ñÀÌ Ç¥½ÃµÇ¸ç, ³»¿ëÀº »óÀÚ¾È¿¡ ´ã°ÜÁý´Ï´Ù.',
    'title_edit' => 'ÆíÁý',
    'title_copy' => 'º¹»ç¸¦ ÀÛ¼º',
