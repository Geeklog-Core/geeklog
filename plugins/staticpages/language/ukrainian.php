...
$LANG_STATIC = array(
    ...
    'page_desc' => 'Setting a previous and/or next page will add HTML link elements rel=вЂќnextвЂќ and rel=вЂќprevвЂќ to the header to indicate the relationship between pages in a paginated series. Actual page navigation links are not added to the page. You have to add these yourself. NOTE: Parent page is currently not being used.',
    'num_pages' => '%s Page(s)'
);
