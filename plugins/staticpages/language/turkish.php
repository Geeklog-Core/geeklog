...
$LANG_STATIC = array(
    ...
    'access_denied_msg' => 'Statik Sayfalar yönetim sayfalaryna yetkisiz giri? demesi yapyyorsunuz. Not: Bu sayfalara yetkisiz giri? denemelerinin hepsi kaydedilmektedir',
    'all_html_allowed' => 'Bütün HTML kodlary kullanylabilir',
    'results' => 'Statik Sayfalar Sonuçlary',
    'author' => 'Yazar',
    'no_title_or_content' => 'En azyndan <b>Ba?lyk</b> ve <b>Yçerik</b> bölümlerini doldurmalysynyz.',
    ...
    'no_such_page_anon' => 'Lütfen giri? yapyn..',
    'no_page_access_msg' => "Bu olabilir çünkü giri? yapmadynyz yada {$_CONF['site_name']} nin kayytly bir üyesi de?ilsiniz. {$_CONF['site_name']} nin tüm üyelik giri?lerini elde etmek için lütfen <a href=\"{$_CONF['site_url']}/users.php?mode=new\"> yeni bir üye olun</a>",
    'php_msg' => 'PHP: ',
    'php_warn' => 'Uyary: ?ayet bu seçene?i kullanyrsanyz, sayfanyz PHP kodunda de?erlendirilir. Dikkatli kullanyn !!',
    'exit_msg' => 'Çyky? Tipi: ',
    'exit_info' => 'Giri? Mesajy Ystemeyi olanakly kylar. Normal güvenlik kontrolü ve mesajy için i?areti kaldyryn.',
    ...
    'id' => 'ID',
    'duplicate_id' => 'Bu statik sayfa için seçti?iniz ID zaten kullanylyyor. Lütfen ba?ka ID seçin.',
    'instructions' => 'Bir statik sayfayy düzenlemek yada silmek isterseniz, a?a?ydaki sayfa numarasyna tyklayynyz. Bir statik sayfayy görüntüleme, görmek istedi?iniz sayfanyn ba?ly?yna tyklyynyz. Yeni bir statik sayfa yaratmak için üstteki Yeni Sayfa linkine tyklayyn. [C] \'ye tyklayarak varolan sayfanyn bir kopyasyny yaratyrsynyz.',
    'centerblock' => 'Ortablok: ',
    'centerblock_msg' => 'Y?aretlenirse, bu statik sayfa index sayfasynda bir orta blokda görüntülenecektir.',
    'topic' => 'Konu: ',
    'position' => 'Pozisyon: ',
    'all_topics' => 'Hepsi',
    'no_topic' => 'Sadece Ana Sayfa',
    'position_top' => 'Sayfanyn Üstü',
    'position_feat' => 'Günün Yazysyndan Sonra',
    'position_bottom' => 'Sayfanyn Alty',
    'position_entire' => 'Tam Sayfa',
    'head_centerblock' => 'Ortablok',
    'centerblock_no' => 'Yok',
    'centerblock_top' => 'Üst',
    'centerblock_feat' => 'Gün. Yazysy',
