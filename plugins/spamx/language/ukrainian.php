 ...
 *
 * $Id: ukrainian.php,v 1.1 2005/12/22 11:56:38 dhaun Exp $
 */
...
$LANG_SX00 = array (
	...
	'note4'		=> 'поверніться сюди і дайте Spam-X перевірити останні коментарі на спам.</li></ul>Коментарі ',
...
$PLG_spamx_MESSAGE3001 = 'Модуль Spam-X успішно оновлено.';
