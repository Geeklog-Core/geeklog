 ...
 *
 * $Id: ukrainian_koi8-u.php,v 1.7 2008/05/02 15:08:10 dhaun Exp $
 */
...
$LANG_SX00 = array(
    ...
    'masshead' => '<hr' . XHTML . '><h1 style="text-align: center;">Масове Вилучення Spam-коментар?в</h1>',
    ...
    'allow_url_fopen' => '<p>Вибачте, конф?гурац?я вашого вебсервера не дозволя? читати в?ддален? файли (<code>allow_url_fopen</code> ма? значення off). Будь-ласка, завантажте чорний список з наступного URL ? пом?ст?ть його в каталог "data" вашого Geeklog, <span style="font-family: monospace;">%s</span>, перш н?ж пробувати знову:',
