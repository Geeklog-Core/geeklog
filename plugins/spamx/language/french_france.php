...
/**
 * File: french.php
 * This is the French language page for the Geeklog SpamX Plug-in!
 * 
...
$LANG_SX00 = array (
    ...
    'submit' => 'Soumettre',
    'subthis' => 'à la base de données centrale SpamX',
    'secbut' => 'Ce second bouton permet de créer un fichier RDF afin de permettre l\'importation de votre liste.',
    'sitename' => 'Nom du Site: ',
    'URL' => 'URL vers la Liste SpamX: ',
    'RDF' => 'URL du fichier RDF: ',
    'impinst1a' => 'Avant d\'utiliser l\'utilitaire anti-comentaires indésirables SpamX pour voir et importer les listes noires personnelles des autres',
    'impinst1b' => ' sites, je vous demande d\'utiliser les deux boutons suivants. (Le dernier est obligatoire.)',
    'impinst2' => 'Le premier soumet votre site web au site Gplugs/SpamX afin de l\'ajouter à la liste principale des ',
    ...
    'pblack' => 'Liste Noire Personnelle SpamX',
    'conmod' => 'Configurer utilisation du module SpamX',
    'acmod' => 'Modules Action de SpamX',
    'exmod' => 'Modules Vérification de SpamX',
    ...
    'viewlog' => 'Voir fichier log SpamX',
    'clearlog' => 'Vider fichier ',
    'logcleared' => '- fichier log SpamX vide',
    'plugin' => 'Plugin',
	...
	'note2'		=> ' commentaire indésirable et que SpamX ne le reconnaît pas.  <ul><li>Trouvez d\'abord le(s) lien(s) ou autre ',
