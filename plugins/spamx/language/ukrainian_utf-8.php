 ...
 *
 * $Id: ukrainian_utf-8.php,v 1.8 2008/05/02 15:08:10 dhaun Exp $
 */
...
$LANG_SX00 = array(
    ...
    'masshead' => '<hr' . XHTML . '><h1 style="text-align: center;">Масове Вилучення Spam-коментарів</h1>',
    'masstb' => '<hr' . XHTML . '><h1 style="text-align: center;">Масове Вилучення трекбек-спаму</h1>',
    ...
    'allow_url_fopen' => '<p>Вибачте, конфігурація вашого вебсервера не дозволяє читати віддалені файли (<code>allow_url_fopen</code> має значення off). Будь-ласка, завантажте чорний список з наступного URL і помістіть його в каталог "data" вашого Geeklog, <span style="font-family: monospace;">%s</span>, перш ніж пробувати знову:',
