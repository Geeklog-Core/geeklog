...
$LANG_SX00 = array(
    ...
    'masshead' => '<hr' . XHTML . '><h1 style="text-align: center;">Masovni izbris spam komentarjev</h1>',
    'masstb' => '<hr' . XHTML . '><h1 style="text-align: center;">Masovni izbris spam trackbackov</h1>',
    ...
    'allow_url_fopen' => '<p>Žal konfiguracija tvojega spletnega strežnika ne dopušèa branja oddaljenih datotek (<code>allow_url_fopen</code> je izkljuèen). Prenesi prosim èrno listo s sledeèega URL in jo naloži v Geeklogov "podatkovni" direktorij, <span style="font-family: monospace;">%s</span>, preden poskusiš ponovno:',
