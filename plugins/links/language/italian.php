...
$LANG_LINKS = array(
    ...
    119 => 'Il Seguente Collegamento &egrave; Stato Segnalato Come Non Funzionante: ',
    120 => 'Clicca Qui Per Modificare il Collegamento: ',
    121 => 'Il Collegamento Non Funzionante &egrave; Stato Segnalato Da: ',
    122 => 'Grazie Per Aver Segnalato Questo Collegamento. L\'amministratore corregger&agrave; questo problema al pi&ugrave; presto possibile',
    123 => 'Grazie',
    124 => 'Invia',
    125 => 'Categorie',
    126 => 'Sei qui:',
...
$LANG_LINKS_SUBMIT = array(
    ...
    7 => 'Specifica il nome di una categorie, se "Altro" &egrave; stato selezionato.',
    8 => 'Titolo',
    9 => 'Indirizzo',
    10 => 'Categoria',
...
$PLG_links_MESSAGE1 = "Grazie per l\'invio del collegamento a {$_CONF['site_name']}.  Presto sar&agrave; esaminato da uno dei amministratori.  Se approvato, verr&agrave; visualizzato in <a href={$_CONF['site_url']}/links/index.php>questa</a> sezione.";
$PLG_links_MESSAGE2 = 'Il tuo collegamento &egrave; stato salvato.';
$PLG_links_MESSAGE3 = 'Il collegamento &egrave; stato eliminato.';
$PLG_links_MESSAGE4 = "Grazie per l\'invio del collegamento a {$_CONF['site_name']}.  &Egrave; ora disponibile in <a href={$_CONF['site_url']}/links/index.php>questa</a> sezione.";
...
$PLG_links_MESSAGE10 = 'La tua categoria &egrave; stata salvata.';
$PLG_links_MESSAGE11 = 'Gli id "site" or "user" sono riservati per uso interno. Scegli un altro id.';
$PLG_links_MESSAGE12 = 'Stai cercando di spostare una categoria nella sua stessa categoria dipendente. Questo non &egrave; permesso. Prego sposta le categorie dipendenti ad un livello superiore e riprova.';
$PLG_links_MESSAGE13 = 'La categoria &egrave; stata eliminata.';
...
$PLG_links_MESSAGE17 = 'Questo id &egrave; gi&agrave; utilizzato da un altra categoria.';

// Messages for the plugin upgrade
$PLG_links_MESSAGE3001 = 'L\'aggiornamento di plugin non &egrave; supportato.';
...
$LANG_LINKS_ADMIN = array(
    ...
    12 => 'Per modificare o eliminare un collegamento, clicca sull\'icona di modifica sottostante. Per creare un nuovo collegamento, clicca su "Nuovo Collegamento" o "Nuova Categoria". Per modificare pi&ugrave; di una categoria, clicca su "Modifica Categorie".',
    14 => 'Categoria del Collegamento',
    16 => 'Accesso Negato',
    17 => "Hai cercato di accedere ad un collegamento per il quale non hai le necessarie autorizzazioni. Questo tentativo &egrave; stato salvato. <a href=\"{$_CONF['site_admin_url']}/plugins/links/index.php\">Ritorna alo scermo amministrativo dei collegamenti</a>.",
    20 => 'Se altro, specifica',
    21 => 'salva',
    22 => 'annulla',
    23 => 'elimina',
    24 => 'Collegamento non trovato',
    25 => 'Il collegamento che hai selezionato non &egrave; stato trovato.',
    ...
    55 => 'Modifica le categorie sottostanti. Nota che non &egrave; possibile eliminare una categoria che contiene altre categorie o collegamenti - prima &egrave; necessario eliminare questi elementi o spostarli in un altra categoria',
    56 => 'Editor Categorie',
    57 => 'Non controllato',
...
$LANG_LINKS_STATUS = array(
    ...
    413 => "Entit&agrave; della richiesta troppo grande",
    414 => "L'indirizzo della richiest &egrave; troppo lungo",
    415 => "Unsupported Media Type",
    416 => "L'Intervallo Richiesto non &egrave; valido",
