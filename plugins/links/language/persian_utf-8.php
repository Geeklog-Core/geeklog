...
$LANG_configsections['links'] = [
    'label' => 'پیوند ها',
    'title' => 'پیکربندی پیوند ها'
];

$LANG_confignames['links'] = [
...
$LANG_configselects['links'] = [
    0  => ['True' => 1, 'False' => 0],
    1  => ['True' => true, 'False' => false],
    9  => ['Forward to Linked Site' => 'item', 'Display Admin List' => 'list', 'Display Public List' => 'plugin', 'Display Home' => 'home', 'Display Admin' => 'admin'],
