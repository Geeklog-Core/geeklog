...
class SitemapXML
{
	...
	* @require          PEAR Date/TimeZone.php
    */
    ...
    * @access  private
    * @param   str            string
    * @param   from_encoding  string  source encoding
    * @return                 string
    ...
    *
    * @access  protected
    * @param   filename   string   the name of the sitemap file
    * @param   sitemap    string   the content of the sitemap
