...
CREATE TABLE [dbo].[{$_TABLES['blocks']}] (
    ...
    [type] [varchar] (20) COLLATE SQL_Latin1_General_CP1_CI_AS NOT NULL DEFAULT 'normal',
    [title] [varchar] (48) COLLATE SQL_Latin1_General_CP1_CI_AS NULL ,
    [blockorder] [numeric](5, 0) NOT NULL ,
    [device] [varchar] (15) ) COLLATE SQL_Latin1_General_CP1_CI_AS NOT NULL DEFAULT 'all',
