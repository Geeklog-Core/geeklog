...
$_SQL[] = "
CREATE TABLE [dbo].[gl_pollanswers] (
...
CREATE TABLE [dbo].[{$_TABLES['userindex']}] (
	...
	[etids] [text] COLLATE SQL_Latin1_General_CP1_CI_AS NOT NULL ,
...
CREATE TABLE [dbo].[{$_TABLES['userinfo']}] (
	...
	[pgpkey] [text] COLLATE SQL_Latin1_General_CP1_CI_AS NULL ,
...
$_SQL[] = "ALTER TABLE [dbo].[gl_pollanswers] ADD 
...
$_SQL[] = "INSERT INTO gl_access (acc_ft_id, acc_grp_id) VALUES (1,3)";
$_SQL[] = "INSERT INTO gl_access (acc_ft_id, acc_grp_id) VALUES (2,3)";
$_SQL[] = "INSERT INTO gl_access (acc_ft_id, acc_grp_id) VALUES (3,5)";
$_SQL[] = "INSERT INTO gl_access (acc_ft_id, acc_grp_id) VALUES (4,5)";
$_SQL[] = "INSERT INTO gl_access (acc_ft_id, acc_grp_id) VALUES (5,9)";
$_SQL[] = "INSERT INTO gl_access (acc_ft_id, acc_grp_id) VALUES (5,11)";
$_SQL[] = "INSERT INTO gl_access (acc_ft_id, acc_grp_id) VALUES (6,9)";
$_SQL[] = "INSERT INTO gl_access (acc_ft_id, acc_grp_id) VALUES (6,11)";
$_SQL[] = "INSERT INTO gl_access (acc_ft_id, acc_grp_id) VALUES(7,12)";
$_SQL[] = "INSERT INTO gl_access (acc_ft_id, acc_grp_id) VALUES (8,7)";
$_SQL[] = "INSERT INTO gl_access (acc_ft_id, acc_grp_id) VALUES (9,7)";
$_SQL[] = "INSERT INTO gl_access (acc_ft_id, acc_grp_id) VALUES (10,4)";
$_SQL[] = "INSERT INTO gl_access (acc_ft_id, acc_grp_id) VALUES (11,6)";
$_SQL[] = "INSERT INTO gl_access (acc_ft_id, acc_grp_id) VALUES (12,8)";
$_SQL[] = "INSERT INTO gl_access (acc_ft_id, acc_grp_id) VALUES (13,10)";
$_SQL[] = "INSERT INTO gl_access (acc_ft_id, acc_grp_id) VALUES (14,11)";
$_SQL[] = "INSERT INTO gl_access (acc_ft_id, acc_grp_id) VALUES (15,11)";
$_SQL[] = "INSERT INTO gl_access (acc_ft_id, acc_grp_id) VALUES (16,4)";
$_SQL[] = "INSERT INTO gl_access (acc_ft_id, acc_grp_id) VALUES (17,14)";
$_SQL[] = "INSERT INTO gl_access (acc_ft_id, acc_grp_id) VALUES (18,14)";
$_SQL[] = "INSERT INTO gl_access (acc_ft_id, acc_grp_id) VALUES (23,15)";
$_SQL[] = "INSERT INTO gl_access (acc_ft_id, acc_grp_id) VALUES (24,3)";


$_SQL[] = "
set identity_insert gl_blocks on


INSERT INTO gl_blocks (bid, is_enabled, name, type, title, tid, blockorder, content, rdfurl, rdfupdated, onleft, phpblockfn, group_id, owner_id, perm_owner, perm_group, perm_members, perm_anon) VALUES (1,1,'user_block','gldefault','User Functions','all',2,'','',getdate(),1,'',1,2,3,3,2,2)
INSERT INTO gl_blocks (bid, is_enabled, name, type, title, tid, blockorder, content, rdfurl, rdfupdated, onleft, phpblockfn, group_id, owner_id, perm_owner, perm_group, perm_members, perm_anon) VALUES (2,1,'admin_block','gldefault','Admins Only','all',1,'','',getdate(),1,'',1,2,3,3,2,2)
INSERT INTO gl_blocks (bid, is_enabled, name, type, title, tid, blockorder, content, rdfurl, rdfupdated, onleft, phpblockfn, group_id, owner_id, perm_owner, perm_group, perm_members, perm_anon) VALUES (3,1,'section_block','gldefault','Topics','all',0,'','',getdate(),1,'',1,2,3,3,2,2)
INSERT INTO gl_blocks (bid, is_enabled, name, type, title, tid, blockorder, content, rdfurl, rdfupdated, onleft, phpblockfn, group_id, owner_id, perm_owner, perm_group, perm_members, perm_anon) VALUES (4,1,'polls_block','phpblock','Poll','all',2,'','',getdate(),0,'phpblock_polls',1,2,3,3,2,2)
INSERT INTO gl_blocks (bid, is_enabled, name, type, title, tid, blockorder, content, rdfurl, rdfupdated, onleft, phpblockfn, group_id, owner_id, perm_owner, perm_group, perm_members, perm_anon) VALUES (5,1,'events_block','gldefault','Events','all',4,'','',getdate(),1,'',1,2,3,3,2,2)
INSERT INTO gl_blocks (bid, is_enabled, name, type, title, tid, blockorder, content, rdfurl, rdfupdated, onleft, phpblockfn, group_id, owner_id, perm_owner, perm_group, perm_members, perm_anon) VALUES (6,1,'whats_new_block','gldefault','What''s New','all',3,'','',getdate(),0,'',1,2,3,3,2,2)
INSERT INTO gl_blocks (bid, is_enabled, name, type, title, tid, blockorder, content, rdfurl, rdfupdated, onleft, phpblockfn, group_id, owner_id, perm_owner, perm_group, perm_members, perm_anon) VALUES (7,1,'first_block','normal','About GeekLog','homeonly',1,'<p><b>Welcome to GeekLog!</b><p>If you''re already familiar with GeekLog - and especially if you''re not: There have been many improvements to GeekLog since earlier versions that you might want to read up on. Please read the <a href=\"docs/changes.html\">release notes</a>. If you need help, please see the <a href=\"docs/support.html\">support options</a>.','',getdate(),0,'',4,2,3,3,2,2)
INSERT INTO gl_blocks (bid, is_enabled, name, type, title, tid, blockorder, content, rdfurl, rdfupdated, onleft, phpblockfn, group_id, owner_id, perm_owner, perm_group, perm_members, perm_anon) VALUES (8,1,'whosonline_block','phpblock','Who''s Online','all',0,'','',getdate(),0,'phpblock_whosonline',4,2,3,3,2,2)
INSERT INTO gl_blocks (bid, is_enabled, name, type, title, tid, blockorder, content, rdfurl, rdfupdated, onleft, phpblockfn, group_id, owner_id, perm_owner, perm_group, perm_members, perm_anon) VALUES (9,1,'older_stories','gldefault','Older Stories','all',5,'','',getdate(),1,'',1,2,3,3,2,2)
INSERT INTO gl_blocks (bid, is_enabled, name, type, title, tid, blockorder, content, rdfurl, rdfupdated, onleft, phpblockfn, group_id, owner_id, perm_owner, perm_group, perm_members, perm_anon) VALUES (10,1,'security_check','phpblock','Are you secure?','homeonly',3,'','',getdate(),1,'phpblock_getBent',1,2,3,3,0,0)


set identity_insert gl_blocks off
";


$_SQL[] = "INSERT INTO gl_commentcodes (code, name) VALUES (0,'Comments Enabled')";
$_SQL[] = "INSERT INTO gl_commentcodes (code, name) VALUES (-1,'Comments Disabled')";

$_SQL[] = "INSERT INTO gl_commentmodes (mode, name) VALUES ('flat','Flat')";
$_SQL[] = "INSERT INTO gl_commentmodes (mode, name) VALUES ('nested','Nested')";
$_SQL[] = "INSERT INTO gl_commentmodes (mode, name) VALUES ('threaded','Threaded')";
$_SQL[] = "INSERT INTO gl_commentmodes (mode, name) VALUES ('nocomment','No Comments')";

$_SQL[] = "INSERT INTO gl_cookiecodes (cc_value, cc_descr) VALUES (0,'(don''t)')";
$_SQL[] = "INSERT INTO gl_cookiecodes (cc_value, cc_descr) VALUES (3600,'1 Hour')";
$_SQL[] = "INSERT INTO gl_cookiecodes (cc_value, cc_descr) VALUES (7200,'2 Hours')";
$_SQL[] = "INSERT INTO gl_cookiecodes (cc_value, cc_descr) VALUES (10800,'3 Hours')";
$_SQL[] = "INSERT INTO gl_cookiecodes (cc_value, cc_descr) VALUES (28800,'8 Hours')";
$_SQL[] = "INSERT INTO gl_cookiecodes (cc_value, cc_descr) VALUES (86400,'1 Day')";
$_SQL[] = "INSERT INTO gl_cookiecodes (cc_value, cc_descr) VALUES (604800,'1 Week')";
$_SQL[] = "INSERT INTO gl_cookiecodes (cc_value, cc_descr) VALUES (2678400,'1 Month')";

$_SQL[] = "INSERT INTO gl_dateformats (dfid, format, description) VALUES (0,'','System Default')";
$_SQL[] = "INSERT INTO gl_dateformats (dfid, format, description) VALUES (1,'%A %B %d, %Y @%I:%M%p','Sunday March 21, 1999 @10:00PM')";
$_SQL[] = "INSERT INTO gl_dateformats (dfid, format, description) VALUES (2,'%A %b %d, %Y @%H:%M','Sunday March 21, 1999 @22:00')";
$_SQL[] = "INSERT INTO gl_dateformats (dfid, format, description) VALUES (4,'%A %b %d @%H:%M','Sunday March 21 @22:00')";
$_SQL[] = "INSERT INTO gl_dateformats (dfid, format, description) VALUES (5,'%H:%M %d %B %Y','22:00 21 March 1999')";
$_SQL[] = "INSERT INTO gl_dateformats (dfid, format, description) VALUES (6,'%H:%M %A %d %B %Y','22:00 Sunday 21 March 1999')";
$_SQL[] = "INSERT INTO gl_dateformats (dfid, format, description) VALUES (7,'%I:%M%p - %A %B %d %Y','10:00PM -- Sunday March 21 1999')";
$_SQL[] = "INSERT INTO gl_dateformats (dfid, format, description) VALUES (8,'%a %B %d, %I:%M%p','Sun March 21, 10:00PM')";
$_SQL[] = "INSERT INTO gl_dateformats (dfid, format, description) VALUES (9,'%a %B %d, %H:%M','Sun March 21, 22:00')";
$_SQL[] = "INSERT INTO gl_dateformats (dfid, format, description) VALUES (10,'%m-%d-%y %H:%M','3-21-99 22:00')";
$_SQL[] = "INSERT INTO gl_dateformats (dfid, format, description) VALUES (11,'%d-%m-%y %H:%M','21-3-99 22:00')";
$_SQL[] = "INSERT INTO gl_dateformats (dfid, format, description) VALUES (12,'%m-%d-%y %I:%M%p','3-21-99 10:00PM')";
$_SQL[] = "INSERT INTO gl_dateformats (dfid, format, description) VALUES (13,'%I:%M%p  %B %D, %Y','10:00PM  March 21st, 1999')";
$_SQL[] = "INSERT INTO gl_dateformats (dfid, format, description) VALUES (14,'%a %b %d, ''%y %I:%M%p','Sun Mar 21, ''99 10:00PM')";
$_SQL[] = "INSERT INTO gl_dateformats (dfid, format, description) VALUES (15,'Day %j, %I ish','Day 80, 10 ish')";
$_SQL[] = "INSERT INTO gl_dateformats (dfid, format, description) VALUES (16,'%y-%m-%d %I:%M','99-03-21 10:00')";
$_SQL[] = "INSERT INTO gl_dateformats (dfid, format, description) VALUES (17,'%d/%m/%y %H:%M','21/03/99 22:00')";
$_SQL[] = "INSERT INTO gl_dateformats (dfid, format, description) VALUES (18,'%a %d %b %I:%M%p','Sun 21 Mar 10:00PM')";

$_SQL[] = "INSERT INTO gl_eventsubmission (eid, title, description, location, datestart, dateend, url, allday, zipcode, state, city, address2, address1, event_type, timestart, timeend) VALUES ('2005100114064662','Geeklog installed','Today, you successfully installed this Geeklog site.','Your webserver',getdate(),getdate(),'http://www.geeklog.net/',1,NULL,NULL,NULL,NULL,NULL,'',NULL,NULL)";

$_SQL[] = "INSERT INTO gl_featurecodes (code, name) VALUES (0,'Not Featured')";
$_SQL[] = "INSERT INTO gl_featurecodes (code, name) VALUES (1,'Featured')";




$_SQL[] = "
set identity_insert gl_features on


INSERT INTO gl_features (ft_id, ft_name, ft_descr, ft_gl_core) VALUES (1,'story.edit','Access to story editor',1)
INSERT INTO gl_features (ft_id, ft_name, ft_descr, ft_gl_core) VALUES (2,'story.moderate','Ability to moderate pending stories',1)
INSERT INTO gl_features (ft_id, ft_name, ft_descr, ft_gl_core) VALUES (5,'user.edit','Access to user editor',1)
INSERT INTO gl_features (ft_id, ft_name, ft_descr, ft_gl_core) VALUES (6,'user.delete','Ability to delete a user',1)
INSERT INTO gl_features (ft_id, ft_name, ft_descr, ft_gl_core) VALUES (7,'user.mail','Ability to send email to members',1)
INSERT INTO gl_features (ft_id, ft_name, ft_descr, ft_gl_core) VALUES (8,'event.moderate','Ability to moderate pending events',1)
INSERT INTO gl_features (ft_id, ft_name, ft_descr, ft_gl_core) VALUES (9,'event.edit','Access to event editor',1)
INSERT INTO gl_features (ft_id, ft_name, ft_descr, ft_gl_core) VALUES (10,'block.edit','Access to block editor',1)
INSERT INTO gl_features (ft_id, ft_name, ft_descr, ft_gl_core) VALUES (11,'topic.edit','Access to topic editor',1)
INSERT INTO gl_features (ft_id, ft_name, ft_descr, ft_gl_core) VALUES (13,'plugin.edit','Access to plugin editor',1)
INSERT INTO gl_features (ft_id, ft_name, ft_descr, ft_gl_core) VALUES (14,'group.edit','Ability to edit groups',1)
INSERT INTO gl_features (ft_id, ft_name, ft_descr, ft_gl_core) VALUES (15,'group.delete','Ability to delete groups',1)
INSERT INTO gl_features (ft_id, ft_name, ft_descr, ft_gl_core) VALUES (16,'block.delete','Ability to delete a block',1)
INSERT INTO gl_features (ft_id, ft_name, ft_descr, ft_gl_core) VALUES (17,'staticpages.edit','Ability to edit a static page',0)
INSERT INTO gl_features (ft_id, ft_name, ft_descr, ft_gl_core) VALUES (18,'staticpages.delete','Ability to delete static pages',0)
INSERT INTO gl_features (ft_id, ft_name, ft_descr, ft_gl_core) VALUES (19,'story.submit','May skip the story submission queue',1)
INSERT INTO gl_features (ft_id, ft_name, ft_descr, ft_gl_core) VALUES (21,'event.submit','May skip the event submission queue',1)
INSERT INTO gl_features (ft_id, ft_name, ft_descr, ft_gl_core) VALUES (22,'staticpages.PHP','Ability use PHP in static pages',0)
INSERT INTO gl_features (ft_id, ft_name, ft_descr, ft_gl_core) VALUES (23,'spamx.admin', 'Full access to Spam-X plugin', 0)
INSERT INTO gl_features (ft_id, ft_name, ft_descr, ft_gl_core) VALUES (24,'story.ping', 'Ability to send pings, pingbacks, or trackbacks for stories', 1)
INSERT INTO gl_features (ft_id, ft_name, ft_descr, ft_gl_core) VALUES (3,'links.moderate','Ability to moderate pending links',0)
INSERT INTO gl_features (ft_id, ft_name, ft_descr, ft_gl_core) VALUES (4,'links.edit','Access to links editor',0)
INSERT INTO gl_features (ft_id, ft_name, ft_descr, ft_gl_core) VALUES (20,'links.submit','May skip the links submission queue',0)
INSERT INTO gl_features (ft_id, ft_name, ft_descr, ft_gl_core) VALUES (12,'polls.edit','Access to polls editor',0)


set identity_insert gl_features off
";



$_SQL[] = "INSERT INTO gl_frontpagecodes (code, name) VALUES (0,'Show Only in Topic')";
$_SQL[] = "INSERT INTO gl_frontpagecodes (code, name) VALUES (1,'Show on Front Page')";

$_SQL[] = "INSERT INTO gl_group_assignments (ug_main_grp_id, ug_uid, ug_grp_id) VALUES (2,1,NULL)";
$_SQL[] = "INSERT INTO gl_group_assignments (ug_main_grp_id, ug_uid, ug_grp_id) VALUES (2,NULL,1)";
$_SQL[] = "INSERT INTO gl_group_assignments (ug_main_grp_id, ug_uid, ug_grp_id) VALUES (3,NULL,1)";
$_SQL[] = "INSERT INTO gl_group_assignments (ug_main_grp_id, ug_uid, ug_grp_id) VALUES (4,NULL,1)";
$_SQL[] = "INSERT INTO gl_group_assignments (ug_main_grp_id, ug_uid, ug_grp_id) VALUES (5,NULL,1)";
$_SQL[] = "INSERT INTO gl_group_assignments (ug_main_grp_id, ug_uid, ug_grp_id) VALUES (6,NULL,1)";
$_SQL[] = "INSERT INTO gl_group_assignments (ug_main_grp_id, ug_uid, ug_grp_id) VALUES (7,NULL,1)";
$_SQL[] = "INSERT INTO gl_group_assignments (ug_main_grp_id, ug_uid, ug_grp_id) VALUES (8,NULL,1)";
$_SQL[] = "INSERT INTO gl_group_assignments (ug_main_grp_id, ug_uid, ug_grp_id) VALUES (9,NULL,1)";
$_SQL[] = "INSERT INTO gl_group_assignments (ug_main_grp_id, ug_uid, ug_grp_id) VALUES (10,NULL,1)";
$_SQL[] = "INSERT INTO gl_group_assignments (ug_main_grp_id, ug_uid, ug_grp_id) VALUES (11,NULL,1)";
$_SQL[] = "INSERT INTO gl_group_assignments (ug_main_grp_id, ug_uid, ug_grp_id) VALUES (13,2,NULL)";
$_SQL[] = "INSERT INTO gl_group_assignments (ug_main_grp_id, ug_uid, ug_grp_id) VALUES (12,2,NULL)";
$_SQL[] = "INSERT INTO gl_group_assignments (ug_main_grp_id, ug_uid, ug_grp_id) VALUES (11,2,NULL)";
$_SQL[] = "INSERT INTO gl_group_assignments (ug_main_grp_id, ug_uid, ug_grp_id) VALUES (2,NULL,12)";
$_SQL[] = "INSERT INTO gl_group_assignments (ug_main_grp_id, ug_uid, ug_grp_id) VALUES (2,NULL,10)";
$_SQL[] = "INSERT INTO gl_group_assignments (ug_main_grp_id, ug_uid, ug_grp_id) VALUES (2,NULL,9)";
$_SQL[] = "INSERT INTO gl_group_assignments (ug_main_grp_id, ug_uid, ug_grp_id) VALUES (2,NULL,8)";
$_SQL[] = "INSERT INTO gl_group_assignments (ug_main_grp_id, ug_uid, ug_grp_id) VALUES (2,NULL,7)";
$_SQL[] = "INSERT INTO gl_group_assignments (ug_main_grp_id, ug_uid, ug_grp_id) VALUES (2,NULL,6)";
$_SQL[] = "INSERT INTO gl_group_assignments (ug_main_grp_id, ug_uid, ug_grp_id) VALUES (2,NULL,5)";
$_SQL[] = "INSERT INTO gl_group_assignments (ug_main_grp_id, ug_uid, ug_grp_id) VALUES (2,NULL,4)";
$_SQL[] = "INSERT INTO gl_group_assignments (ug_main_grp_id, ug_uid, ug_grp_id) VALUES (2,NULL,3)";
$_SQL[] = "INSERT INTO gl_group_assignments (ug_main_grp_id, ug_uid, ug_grp_id) VALUES (12,NULL,1)";
$_SQL[] = "INSERT INTO gl_group_assignments (ug_main_grp_id, ug_uid, ug_grp_id) VALUES (9,NULL,11)";
$_SQL[] = "INSERT INTO gl_group_assignments (ug_main_grp_id, ug_uid, ug_grp_id) VALUES (2,NULL,11)";
$_SQL[] = "INSERT INTO gl_group_assignments (ug_main_grp_id, ug_uid, ug_grp_id) VALUES (10,2,NULL)";
$_SQL[] = "INSERT INTO gl_group_assignments (ug_main_grp_id, ug_uid, ug_grp_id) VALUES (9,2,NULL)";
$_SQL[] = "INSERT INTO gl_group_assignments (ug_main_grp_id, ug_uid, ug_grp_id) VALUES (8,2,NULL)";
$_SQL[] = "INSERT INTO gl_group_assignments (ug_main_grp_id, ug_uid, ug_grp_id) VALUES (7,2,NULL)";
$_SQL[] = "INSERT INTO gl_group_assignments (ug_main_grp_id, ug_uid, ug_grp_id) VALUES (6,2,NULL)";
$_SQL[] = "INSERT INTO gl_group_assignments (ug_main_grp_id, ug_uid, ug_grp_id) VALUES (5,2,NULL)";
$_SQL[] = "INSERT INTO gl_group_assignments (ug_main_grp_id, ug_uid, ug_grp_id) VALUES (4,2,NULL)";
$_SQL[] = "INSERT INTO gl_group_assignments (ug_main_grp_id, ug_uid, ug_grp_id) VALUES (3,2,NULL)";
$_SQL[] = "INSERT INTO gl_group_assignments (ug_main_grp_id, ug_uid, ug_grp_id) VALUES (2,2,NULL)";
$_SQL[] = "INSERT INTO gl_group_assignments (ug_main_grp_id, ug_uid, ug_grp_id) VALUES (1,2,NULL)";
$_SQL[] = "INSERT INTO gl_group_assignments (ug_main_grp_id, ug_uid, ug_grp_id) VALUES (14,NULL,1)";
$_SQL[] = "INSERT INTO gl_group_assignments (ug_main_grp_id, ug_uid, ug_grp_id) VALUES (15,NULL,1)";



$_SQL[] = "
set identity_insert gl_groups on

INSERT INTO gl_groups (grp_id, grp_name, grp_descr, grp_gl_core) VALUES (1,'Root','Has full access to the site',1)
INSERT INTO gl_groups (grp_id, grp_name, grp_descr, grp_gl_core) VALUES (2,'All Users','Group that a typical user is added to',1)
INSERT INTO gl_groups (grp_id, grp_name, grp_descr, grp_gl_core) VALUES (3,'Story Admin','Has full access to story features',1)
INSERT INTO gl_groups (grp_id, grp_name, grp_descr, grp_gl_core) VALUES (4,'Block Admin','Has full access to block features',1)
INSERT INTO gl_groups (grp_id, grp_name, grp_descr, grp_gl_core) VALUES (5,'Links Admin','Has full access to links features',0)
INSERT INTO gl_groups (grp_id, grp_name, grp_descr, grp_gl_core) VALUES (6,'Topic Admin','Has full access to topic features',1)
INSERT INTO gl_groups (grp_id, grp_name, grp_descr, grp_gl_core) VALUES (7,'Event Admin','Has full access to event features',1)
INSERT INTO gl_groups (grp_id, grp_name, grp_descr, grp_gl_core) VALUES (8,'Polls Admin','Has full access to polls features',0)
INSERT INTO gl_groups (grp_id, grp_name, grp_descr, grp_gl_core) VALUES (9,'User Admin','Has full access to user features',1)
INSERT INTO gl_groups (grp_id, grp_name, grp_descr, grp_gl_core) VALUES (10,'Plugin Admin','Has full access to plugin features',1)
INSERT INTO gl_groups (grp_id, grp_name, grp_descr, grp_gl_core) VALUES (11,'Group Admin','Is a User Admin with access to groups, too',1)
INSERT INTO gl_groups (grp_id, grp_name, grp_descr, grp_gl_core) VALUES (12,'Mail Admin','Can use Mail Utility',1)
INSERT INTO gl_groups (grp_id, grp_name, grp_descr, grp_gl_core) VALUES (13,'Logged-in Users','All registered members',1)
INSERT INTO gl_groups (grp_id, grp_name, grp_descr, grp_gl_core) VALUES (14,'Static Page Admin','Can administer static pages',0)
INSERT INTO gl_groups (grp_id, grp_name, grp_descr, grp_gl_core) VALUES (15,'spamx Admin', 'Users in this group can administer the Spam-X plugin',0)
INSERT INTO gl_groups (grp_id, grp_name, grp_descr, grp_gl_core) VALUES (16,'Remote Users', 'Users in this group can have authenticated against a remote server.',1)


set identity_insert gl_groups off
";


$_SQL[] = "INSERT INTO gl_links (lid, category, url, description, title, date, owner_id, group_id) VALUES ('geeklog.net','Geeklog Sites','http://www.geeklog.net/','Visit the Geeklog homepage for support, FAQs, updates, add-ons, and a great community.','Geeklog Project Homepage',getdate(),1,5)";

$_SQL[] = "INSERT INTO gl_maillist (code, name) VALUES (0,'Don''t Email')";
$_SQL[] = "INSERT INTO gl_maillist (code, name) VALUES (1,'Email Headlines Each Night')";


$_SQL[] = "
set identity_insert gl_pingservice on

INSERT INTO gl_pingservice (pid, name, site_url, ping_url, method, is_enabled) VALUES (1, 'Ping-O-Matic', 'http://pingomatic.com/', 'http://rpc.pingomatic.com/', 'weblogUpdates.ping', 1)

set identity_insert gl_pingservice off
";



$_SQL[] = "INSERT INTO gl_plugins (pi_name, pi_version, pi_gl_version, pi_enabled, pi_homepage) VALUES ('staticpages', '1.4.2','1.4.0',1,'http://www.geeklog.net/')";
$_SQL[] = "INSERT INTO gl_plugins (pi_name, pi_version, pi_gl_version, pi_enabled, pi_homepage) VALUES ('spamx', '1.0.3','1.4.0',1,'http://www.pigstye.net/gplugs/staticpages/index.php/spamx')";
$_SQL[] = "INSERT INTO gl_plugins (pi_name, pi_version, pi_gl_version, pi_enabled, pi_homepage) VALUES ('links', '1.0', '1.4.0', 1, 'http://www.geeklog.net/')";
$_SQL[] = "INSERT INTO gl_plugins (pi_name, pi_version, pi_gl_version, pi_enabled, pi_homepage) VALUES ('polls', '1.0', '1.4.0', '1', 'http://www.geeklog.net/')";

$_SQL[] = "INSERT INTO gl_pollanswers (qid, aid, answer, votes) VALUES ('geeklogfeaturepoll',1,'Trackbacks',0)";
$_SQL[] = "INSERT INTO gl_pollanswers (qid, aid, answer, votes) VALUES ('geeklogfeaturepoll',2,'Links and Polls plugins',0)";
$_SQL[] = "INSERT INTO gl_pollanswers (qid, aid, answer, votes) VALUES ('geeklogfeaturepoll',3,'Revamped admin areas',0)";
$_SQL[] = "INSERT INTO gl_pollanswers (qid, aid, answer, votes) VALUES ('geeklogfeaturepoll',4,'FCKeditor included',0)";
$_SQL[] = "INSERT INTO gl_pollanswers (qid, aid, answer, votes) VALUES ('geeklogfeaturepoll',5,'Remote user authentication',0)";
$_SQL[] = "INSERT INTO gl_pollanswers (qid, aid, answer, votes) VALUES ('geeklogfeaturepoll',6,'Other',0)";

$_SQL[] = "INSERT INTO gl_pollquestions (qid, question, voters, date, display, commentcode, statuscode, owner_id, group_id, perm_owner, perm_group) VALUES ('geeklogfeaturepoll','What is the best new feature of Geeklog?',0,getdate(),1,0,0,2,8,3,3)";

$_SQL[] = "INSERT INTO gl_postmodes (code, name) VALUES ('plaintext','Plain Old Text')";
$_SQL[] = "INSERT INTO gl_postmodes (code, name) VALUES ('html','HTML Formatted')";

$_SQL[] = "INSERT INTO gl_sortcodes (code, name) VALUES ('ASC','Oldest First')";
$_SQL[] = "INSERT INTO gl_sortcodes (code, name) VALUES ('DESC','Newest First')";

$_SQL[] = "INSERT INTO gl_statuscodes (code, name) VALUES (1,'Refreshing')";
$_SQL[] = "INSERT INTO gl_statuscodes (code, name) VALUES (0,'Normal')";
$_SQL[] = "INSERT INTO gl_statuscodes (code, name) VALUES (10,'Archive')";

$_SQL[] = "INSERT INTO gl_stories (sid, uid, draft_flag, tid, date, title, introtext, bodytext, hits, numemails, comments, related, featured, commentcode, statuscode, postmode, frontpage, owner_id, group_id, perm_owner, perm_group, perm_members, perm_anon) VALUES ('welcome',2,0,'GeekLog',getdate(),'Welcome to Geeklog!','<p>Welcome and let me be the first to congratulate you on installing GeekLog. Please take the time to read everything in the <a href=\"docs/index.html\">docs directory</a>. Geeklog now has enhanced, user-based security.  You should thoroughly understand how these work before you run a production Geeklog Site.\r\r<p>To log into your new GeekLog site, please use this account:\r<p>Username: <b>Admin</b><br>\rPassword: <b>password</b>','<p><b>And don''t forget to change your password after logging in!</b>',100,1,0,'',1,0,0,'html',1,2,3,3,2,2,2)";

$_SQL[] = "INSERT INTO gl_storysubmission (sid, uid, tid, title, introtext, date, postmode) VALUES ('security-reminder',2,'GeekLog','Are you secure?','<p>This is a reminder to secure your site once you have Geeklog up and running. What you should do:</p>\r\r<ol>\r<li>Change the default password for the Admin account.</li>\r<li>Remove the install directory (you won''t need it any more).</li>\r</ol>',getdate(),'html')";

$_SQL[] = "INSERT INTO gl_syndication (type, topic, header_tid, format, limits, content_length, title, description, filename, charset, language, is_enabled, updated, update_info) VALUES ('geeklog', '::all', 'all', 'RSS-2.0', 10, 1, 'Geeklog Site', 'Another Nifty Geeklog Site', 'geeklog.rss', 'UTF-8', 'en-gb', 1, getdate(), NULL)";

$_SQL[] = "INSERT INTO gl_topics (tid, topic, imageurl, sortnum, limitnews, group_id, owner_id, perm_owner, perm_group, perm_members, perm_anon) VALUES ('General','General News','/images/topics/topic_news.gif',1,10,6,2,3,2,2,2)";
$_SQL[] = "INSERT INTO gl_topics (tid, topic, imageurl, sortnum, limitnews, group_id, owner_id, perm_owner, perm_group, perm_members, perm_anon) VALUES ('GeekLog','GeekLog','/images/topics/topic_gl.gif',2,10,6,2,3,2,2,2)";

$_SQL[] = "INSERT INTO gl_tzcodes (tz, offset, description) VALUES ('ndt',-9000,'Newfoundland Daylight')";
$_SQL[] = "INSERT INTO gl_tzcodes (tz, offset, description) VALUES ('adt',-10800,'Atlantic Daylight')";
$_SQL[] = "INSERT INTO gl_tzcodes (tz, offset, description) VALUES ('edt',-14400,'Eastern Daylight')";
$_SQL[] = "INSERT INTO gl_tzcodes (tz, offset, description) VALUES ('cdt',-18000,'Central Daylight')";
$_SQL[] = "INSERT INTO gl_tzcodes (tz, offset, description) VALUES ('mdt',-21600,'Mountain Daylight')";
$_SQL[] = "INSERT INTO gl_tzcodes (tz, offset, description) VALUES ('pdt',-25200,'Pacific Daylight')";
$_SQL[] = "INSERT INTO gl_tzcodes (tz, offset, description) VALUES ('ydt',-28800,'Yukon Daylight')";
$_SQL[] = "INSERT INTO gl_tzcodes (tz, offset, description) VALUES ('hdt',-32400,'Hawaii Daylight')";
$_SQL[] = "INSERT INTO gl_tzcodes (tz, offset, description) VALUES ('bst',3600,'British Summer')";
$_SQL[] = "INSERT INTO gl_tzcodes (tz, offset, description) VALUES ('mes',7200,'Middle European Summer')";
$_SQL[] = "INSERT INTO gl_tzcodes (tz, offset, description) VALUES ('sst',7200,'Swedish Summer')";
$_SQL[] = "INSERT INTO gl_tzcodes (tz, offset, description) VALUES ('fst',7200,'French Summer')";
$_SQL[] = "INSERT INTO gl_tzcodes (tz, offset, description) VALUES ('wad',28800,'West Australian Daylight')";
$_SQL[] = "INSERT INTO gl_tzcodes (tz, offset, description) VALUES ('cad',37800,'Central Australian Daylight')";
$_SQL[] = "INSERT INTO gl_tzcodes (tz, offset, description) VALUES ('ead',39600,'Eastern Australian Daylight')";
$_SQL[] = "INSERT INTO gl_tzcodes (tz, offset, description) VALUES ('nzd',46800,'New Zealand Daylight')";
$_SQL[] = "INSERT INTO gl_tzcodes (tz, offset, description) VALUES ('gmt',0,'Greenwich Mean')";
$_SQL[] = "INSERT INTO gl_tzcodes (tz, offset, description) VALUES ('utc',0,'Universal (Coordinated)')";
$_SQL[] = "INSERT INTO gl_tzcodes (tz, offset, description) VALUES ('wet',0,'Western European')";
$_SQL[] = "INSERT INTO gl_tzcodes (tz, offset, description) VALUES ('wat',-3600,'West Africa')";
$_SQL[] = "INSERT INTO gl_tzcodes (tz, offset, description) VALUES ('at',-7200,'Azores')";
$_SQL[] = "INSERT INTO gl_tzcodes (tz, offset, description) VALUES ('gst',-10800,'Greenland Standard')";
$_SQL[] = "INSERT INTO gl_tzcodes (tz, offset, description) VALUES ('nft',-12600,'Newfoundland')";
$_SQL[] = "INSERT INTO gl_tzcodes (tz, offset, description) VALUES ('nst',-12600,'Newfoundland Standard')";
$_SQL[] = "INSERT INTO gl_tzcodes (tz, offset, description) VALUES ('ast',-14400,'Atlantic Standard')";
$_SQL[] = "INSERT INTO gl_tzcodes (tz, offset, description) VALUES ('est',-18000,'Eastern Standard')";
$_SQL[] = "INSERT INTO gl_tzcodes (tz, offset, description) VALUES ('cst',-21600,'Central Standard')";
$_SQL[] = "INSERT INTO gl_tzcodes (tz, offset, description) VALUES ('mst',-25200,'Mountain Standard')";
$_SQL[] = "INSERT INTO gl_tzcodes (tz, offset, description) VALUES ('pst',-28800,'Pacific Standard')";
$_SQL[] = "INSERT INTO gl_tzcodes (tz, offset, description) VALUES ('yst',-32400,'Yukon Standard')";
$_SQL[] = "INSERT INTO gl_tzcodes (tz, offset, description) VALUES ('hst',-36000,'Hawaii Standard')";
$_SQL[] = "INSERT INTO gl_tzcodes (tz, offset, description) VALUES ('cat',-36000,'Central Alaska')";
$_SQL[] = "INSERT INTO gl_tzcodes (tz, offset, description) VALUES ('ahs',-36000,'Alaska-Hawaii Standard')";
$_SQL[] = "INSERT INTO gl_tzcodes (tz, offset, description) VALUES ('nt',-39600,'Nome')";
$_SQL[] = "INSERT INTO gl_tzcodes (tz, offset, description) VALUES ('idl',-43200,'International Date Line West')";
$_SQL[] = "INSERT INTO gl_tzcodes (tz, offset, description) VALUES ('cet',3600,'Central European')";
$_SQL[] = "INSERT INTO gl_tzcodes (tz, offset, description) VALUES ('met',3600,'Middle European')";
$_SQL[] = "INSERT INTO gl_tzcodes (tz, offset, description) VALUES ('mew',3600,'Middle European Winter')";
$_SQL[] = "INSERT INTO gl_tzcodes (tz, offset, description) VALUES ('swt',3600,'Swedish Winter')";
$_SQL[] = "INSERT INTO gl_tzcodes (tz, offset, description) VALUES ('fwt',3600,'French Winter')";
$_SQL[] = "INSERT INTO gl_tzcodes (tz, offset, description) VALUES ('eet',7200,'Eastern Europe, USSR Zone 1')";
$_SQL[] = "INSERT INTO gl_tzcodes (tz, offset, description) VALUES ('bt',10800,'Baghdad, USSR Zone 2')";
$_SQL[] = "INSERT INTO gl_tzcodes (tz, offset, description) VALUES ('it',12600,'Iran')";
$_SQL[] = "INSERT INTO gl_tzcodes (tz, offset, description) VALUES ('zp4',14400,'USSR Zone 3')";
$_SQL[] = "INSERT INTO gl_tzcodes (tz, offset, description) VALUES ('zp5',18000,'USSR Zone 4')";
$_SQL[] = "INSERT INTO gl_tzcodes (tz, offset, description) VALUES ('ist',19800,'Indian Standard')";
$_SQL[] = "INSERT INTO gl_tzcodes (tz, offset, description) VALUES ('zp6',21600,'USSR Zone 5')";
$_SQL[] = "INSERT INTO gl_tzcodes (tz, offset, description) VALUES ('was',25200,'West Australian Standard')";
$_SQL[] = "INSERT INTO gl_tzcodes (tz, offset, description) VALUES ('jt',27000,'Java (3pm in Cronusland!)')";
$_SQL[] = "INSERT INTO gl_tzcodes (tz, offset, description) VALUES ('cct',28800,'China Coast, USSR Zone 7')";
$_SQL[] = "INSERT INTO gl_tzcodes (tz, offset, description) VALUES ('jst',32400,'Japan Standard, USSR Zone 8')";
$_SQL[] = "INSERT INTO gl_tzcodes (tz, offset, description) VALUES ('cas',34200,'Central Australian Standard')";
$_SQL[] = "INSERT INTO gl_tzcodes (tz, offset, description) VALUES ('eas',36000,'Eastern Australian Standard')";
$_SQL[] = "INSERT INTO gl_tzcodes (tz, offset, description) VALUES ('nzt',43200,'New Zealand')";
$_SQL[] = "INSERT INTO gl_tzcodes (tz, offset, description) VALUES ('nzs',43200,'New Zealand Standard')";
$_SQL[] = "INSERT INTO gl_tzcodes (tz, offset, description) VALUES ('id2',43200,'International Date Line East')";
$_SQL[] = "INSERT INTO gl_tzcodes (tz, offset, description) VALUES ('idt',10800,'Israel Daylight')";
$_SQL[] = "INSERT INTO gl_tzcodes (tz, offset, description) VALUES ('iss',7200,'Israel Standard')";

$_SQL[] = "INSERT INTO gl_usercomment (uid, commentmode, commentorder, commentlimit) VALUES (1,'nested','ASC',100)";
$_SQL[] = "INSERT INTO gl_usercomment (uid, commentmode, commentorder, commentlimit) VALUES (2,'threaded','ASC',100)";

$_SQL[] = "INSERT INTO gl_userindex (uid, tids, etids, aids, boxes, noboxes, maxstories) VALUES (1,'','-','','',0,NULL)";
$_SQL[] = "INSERT INTO gl_userindex (uid, tids, etids, aids, boxes, noboxes, maxstories) VALUES (2,'','','','',0,NULL)";

$_SQL[] = "INSERT INTO gl_userinfo (uid, about, pgpkey, userspace, tokens, totalcomments, lastgranted) VALUES (1,NULL,NULL,'',0,0,0)";
$_SQL[] = "INSERT INTO gl_userinfo (uid, about, pgpkey, userspace, tokens, totalcomments, lastgranted) VALUES (2,NULL,NULL,'',0,0,0)";

$_SQL[] = "INSERT INTO gl_userprefs (uid, noicons, willing, dfid, tzid, emailstories) VALUES (1,0,0,0,'',0)";
$_SQL[] = "INSERT INTO gl_userprefs (uid, noicons, willing, dfid, tzid, emailstories) VALUES (2,0,1,0,'edt',1)";

$_SQL[] = "
set identity_insert gl_users on

INSERT INTO gl_users (uid, username, fullname, passwd, email, homepage, sig, regdate, cookietimeout, theme, status) VALUES (1,'Anonymous','Anonymous','',NULL,NULL,'',getdate(),0,NULL,3)
INSERT INTO gl_users (uid, username, fullname, passwd, email, homepage, sig, regdate, cookietimeout, theme, status) VALUES (2,'Admin','Geeklog SuperUser','5f4dcc3b5aa765d61d8327deb882cf99','root@localhost','http://www.geeklog.net/','',getdate(),28800,NULL,3)

set identity_insert gl_users off
";


$_SQL[] = "INSERT INTO gl_vars (name, value) VALUES ('totalhits','0')";
$_SQL[] = "INSERT INTO gl_vars (name, value) VALUES ('lastemailedstories','')";
$_SQL[] = "INSERT INTO gl_vars (name, value) VALUES ('last_scheduled_run','')";
$_SQL[] = "INSERT INTO gl_vars (name, value) VALUES ('spamx.counter','0')";

$_SQL[] = "INSERT INTO gl_trackbackcodes (code, name) VALUES (0,'Trackback Enabled')";
$_SQL[] = "INSERT INTO gl_trackbackcodes (code, name) VALUES (-1,'Trackback Disabled')";
