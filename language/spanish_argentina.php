...
$LANG22 = array(
	...
	16 => "Acceso Denegado",
	17 => "No tiene permiso para acceder a este Evento. Todo intento de acceso será registrado. Por favor, vuelva a <a href=\"{$_CONF["site_url"]}/admin/event.php\">la página de Administración de Eventos</a>.",
	18 => 'Nuevo Evento',
...
$LANG23 = array(
	...
	15 => "URL",
	16 => "Acceso Denegado",
	17 => "No tiene permiso para acceder a este Link. Todo intento de acceso será registrado. Por favor, vuelva a <a href=\"{$_CONF["site_url"]}/admin/link.php\">la página de Administración de Links</a>.",
	18 => 'Nuevo Link',
	19 => 'Página de Inicio - Administrador',
...
$LANG24 = array(
	...
	39 => "Emails",
	40 => "Acceso Denegado",
	41 => "Esta intentando acceder a una Nota pra la cual no tiene derechos de acceso, por lo que podrá ver la Nota pero no editarla. Por favor vuelva a la <a href=\"{$_CONF["site_url"]}/admin/story.php\">página de administración</a> cuando haya terminado.",
	42 => "Esta intentando acceder a una Nota pra la cual no tiene derechos de acceso. Por favor vuelva a la <a href=\"{$_CONF["site_url"]}/admin/story.php\">página de administración</a>.",
	43 => 'Nueva Nota',
...
$LANG25 = array(
	...
	20 => "Votantes",
	21 => "Acceso Denegado",
	22 => "Esta intentando acceder a una Encuesta pra la cual no tiene derechos de acceso. Por favor vuelva a la <a href=\"{$_CONF["site_url"]}/admin/poll.php\">página de administración</a>.",
	23 => 'Nueva Encuesta',
...
$LANG27 = array(
	...
	11 => "Notas/Página",
	12 => "Acceso Denegado",
	13 => "Esta intentando acceder a una Sección pra la cual no tiene derechos de acceso. Por favor vuelva a la <a href=\"{$_CONF["site_url"]}/admin/topic.php\">página de administración</a>.",
	14 => "Ordenamiento",
	15 => "alfabético",
	16 => "por defecto es",
	17 => "Nueva Sección",
...
$LANG31 = array(
	...
	17 => "<a href=" . $_CONF["site_url"] . "/admin/mail.php>Enviar otro mensaje</a>",
        18 => "Para",
        19 => "NOTA: si desea enviar un mensaje a todos los miembros del sitio, seleccione el grupo Logged-In Users en la lista.",
        20 => "Se han enviado <successcount> mensajes con éxito y <failcount> han fallado.  Si desea, los detalles de cada envío figuran abajo. Tambien puede <a href=\"" . $_CONF['site_url'] . "/admin/mail.php\">enviar otro mensaje</a> o volver a <a href=\"" . $_CONF['site_url'] . "/admin/moderation.php\">la página de administración</a>.",
        21 => 'Fallidos',
        22 => 'Exitosos',
