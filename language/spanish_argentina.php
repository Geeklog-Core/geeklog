...
$LANG01 = array(
    ...
    57 => 'Password',
    58 => 'Ingresar',
    59 => "�No tiene una cuenta todav�a? <a href=\"{$_CONF['site_url']}/users.php?mode=new\" rel=\"nofollow\">Inscr�base</a>",
...
$LANG04 = array(
    ...
    66 => "Los datos ingresados no son v�lidos. Intente volver a conectarse aqu�. �Es usted un <a href=\"{$_CONF['site_url']}/users.php?mode=new\" rel=\"nofollow\">usuario nuevo</a>?",
    67 => 'Miembro desde',
    68 => 'Recu�rdeme para',
...
$LANG08 = array(
    ...
    23 => "Este email fue enviado a Ud por %s en %s porque pens� que podr�a interesarle esta Nota en  {$_CONF['site_url']}. Esto no es SPAM y los emails involucrados en este env�o no fueron guardados para ning�n uso posterior.",
...
$LANG20 = array(
    ...
    4 => 'Usuario:',
    5 => 'Password:',
    6 => 'Todo acceso a las partes administrativas es registrado y revisado.<br' . XHTML . '>Esta p�gina es para uso exclusivo del personal autorizado.',
    7 => 'Ingresar',
    8 => 'Login',
...
$LANG24 = array(
    ...
    39 => 'Emails',
    40 => '',
    41 => "Esta intentando acceder a una Nota para la cual no tiene derechos de acceso, por lo que podr� ver la Nota pero no editarla. Por favor vuelva a la <a href=\"{$_CONF['site_admin_url']}/article.php\">p�gina de administraci�n</a> cuando haya terminado.",
    42 => "Esta intentando acceder a una Nota para la cual no tiene derechos de acceso. Por favor vuelva a la <a href=\"{$_CONF['site_admin_url']}/article.php\">p�gina de administraci�n</a>.",
    43 => '',
    44 => '',
    45 => '',
    46 => '<b>NOTA:</b> si modifica esta fecha por una futura, la Nota no ser� publicada hasta esa fecha. Esto tambi�n incluye el envi� de titulares RDF(Resource Description Framework), la b�squeda y las estad�sticas del sitio.',
    47 => 'Im�genes',
    48 => 'imagen',
    49 => 'der',
    50 => 'izq',
    51 => 'Para insertar una imagen en la Nota debe incluir un texto con el formato [imageX], [imageX_right] o [imageX_left], donde X es el n�mero de imagen dentro de la lista. NOTA: s�lo puede utilizar las im�genes de la lista, sino la Nota no podr� ser grabada',
    52 => '',
...
$LANG32 = array(
    ...
    9 => 'Este Plug-in requiere una versi�n m�s nueva de Geeklog. Puede obtener una copia actualizada de <a href="https://www.geeklog.net">Geeklog</a> o instalar otra versi�n del Plug-in.',
...
$LANG_ACCESS = array(
    ...
    'storydenialmsg' => "No tiene acceso para ver esta Nota. Esto puede ser porque no es miembro de {$_CONF['site_name']}. Por favor <a href=\"{$_CONF['site_url']}/users.php?mode=new\" rel=\"nofollow\">convi�rtase en un miembro</a> de {$_CONF['site_name']} para tener acceso.",
...
$LANG_404 = array(
    ...
    3 => "<p>Lo sentimos, pero el archivo que pides no existe. Por favor, consulta la <a href=\"{$_CONF['site_url']}\">p�gina principal</a> o la <a href=\"{$_CONF['site_url']}/search.php\">p�gina de b�squeda</a> para ver si puedes encontrar lo que has perdido.",
