...
$LANG01 = array(
    ...
    57 => 'Password',
    58 => 'Entrar',
    59 => "Ainda n�o tem uma conta?  Inscreva-se como <a href=\"{$_CONF['site_url']}/users.php?mode=new\" rel=\"nofollow\">Novo Utilizador</a>",
...
$LANG04 = array(
    ...
    66 => "� provavel que se tenha enganado nos seus dados de login.  Tente fazer o login novamente. � um <a href=\"{$_CONF['site_url']}/users.php?mode=new\" rel=\"nofollow\">novo utilizador</a>?",
    67 => 'Membro desde',
    68 => 'Lembrar durante',
    ...
    71 => "Uma das op��es do site {$_CONF['site_name']} � que pode personalizar o cont�udo que quer ver e a apar�ncia do site.  Para poder usar esta op��o deve-se <a href=\"{$_CONF['site_url']}/users.php?mode=new\" rel=\"nofollow\">registar</a> em {$_CONF['site_name']}.  J� � um membro registado?  Ent�o utilize o formul�rio de login do lado esquerdo!",
    72 => 'Tema',
    73 => 'Idioma',
...
$LANG20 = array(
    ...
    4 => 'Utilizador:',
    5 => 'Password:',
    6 => 'Todos os acessos administrativos deste site s�o registados e auditados.<br' . XHTML . '>Est� p�gina � apenas para utiliza��o de pessoal autorizado.',
    7 => 'login',
    8 => 'Login',
...
$LANG24 = array(
    ...
    39 => 'Emails',
    40 => '',
    41 => "Est� a tentar aceder a uma not�cia para a qual n�o tem permiss�es.  Esta ac��o ficou registada.  Pode ver esta not�cia com permiss�es de leitura a seguir. Por favor <a href=\"{$_CONF['site_admin_url']}/article.php\">volte ao �cran de administra��o de not�cias</a> quando terminar.",
    42 => "Est� a tentar aceder a uma not�cia para a qual n�o tem permiss�es.  Esta ac��o ficou registada.  Por favor <a href=\"{$_CONF['site_admin_url']}/article.php\">volte ao �cran de administra��o de not�cias</a>.",
    43 => '',
    44 => '',
    45 => '',
...
$LANG32 = array(
    ...
    9 => 'Este plugin necessita de uma vers�o mais recente do Geeklog. Fa�a a actualiza��o da sua c�pia do <a href="https://www.geeklog.net">Geeklog</a> ou procure outra vers�o do plug-in.',
    10 => '<br' . XHTML . '><b>N�o h� plugins instalados.</b><br' . XHTML . '><br' . XHTML . '>',
...
$LANG_ACCESS = array(
    ...
    'storydenialmsg' => "N�o tem permiss�o para ver esta not�cia.  Isto pode acontecer porque voc� n�o � membro do site {$_CONF['site_name']}.  <a href=\"{$_CONF['site_url']}/users.php?mode=new\" rel=\"nofollow\"> Torne-se membro</a> do site {$_CONF['site_name']} para ter acesso como utilizador registado!",
