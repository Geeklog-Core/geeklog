...
$LANG01 = array(
    ...
    57 => 'Contrassenya',
    58 => 'Identificaci�',
    59 => "�Encara no tens una conta? <a href=\"{$_CONF['site_url']}/users.php?mode=new\" rel=\"nofollow\">Inscr�u-te</a>",
...
$LANG04 = array(
    ...
    66 => "Les dades ingressades no son v�lides. Intenta reconectar a sota. �Ets un <a href=\"{$_CONF['site_url']}/users.php?mode=new\" rel=\"nofollow\">usuari/a nou/va</a>?",
    67 => 'Membre desde',
    68 => 'Recorda\'m durant',
    ...
    71 => "Una de les grans virtuts de {$_CONF['site_name']} es que pots personalitzar el contingut que reps i l\'aparen�a del lloc. Per poder fer-ho, primer has d\'<a href=\"{$_CONF['site_url']}/users.php?mode=new\" rel=\"nofollow\">inscriure\'t</a> a {$_CONF['site_name']}. Si ja ets membre, utilitza el formulari de l\'esquerra per conectar-te.",
    72 => 'Tema',
    73 => 'Idioma',
...
$LANG20 = array(
    ...
    4 => 'Usuari/a:',
    5 => 'Contrassenya:',
    6 => 'Tot acc�s a les parts administratives queda registrat i revisat.<br' . XHTML . '>Aquesta p�gina �s per l\'�s exclusiu del personal autoritzat.',
    7 => 'Identificaci�',
    8 => 'Login',
...
$LANG24 = array(
    ...
    40 => '',
    41 => "Est�s intentant accedir a una Not�cia a la que no tens drets d\'acc�s, per tant, podr�s veure la Not�cia per� no editar-la. Siusplau torna a la <a href=\"{$_CONF['site_admin_url']}/article.php\">p�gina d\'administraci�</a> quan hagis acabat.",
    42 => "Est�s intentant accedir a una Not�cia a la que no tens drets d\'acc�s. Siusplau torna a la <a href=\"{$_CONF['site_admin_url']}/article.php\">p�gina d\'administraci�</a>.",
    43 => '',
    44 => '',
    45 => '',
...
$LANG32 = array(
    ...
    9 => 'Aquest Plug-in requereix una versi� m�s nova de Geeklog. Pots obtenir una c�pia actualitzada de <a href=https://www.geeklog.net>Geeklog</a> o instal�lar una altre versi� del Plug-in.',
...
$LANG_ACCESS = array(
    ...
    'storydenialmsg' => "No tens acc�s per veure aquesta Not�cia. Aix� pot ser perqu� no ets membre de {$_CONF['site_name']}. Siusplau <a href=\"{$_CONF['site_url']}/users.php?mode=new\" rel=\"nofollow\">entra entra com a membre</a> de {$_CONF['site_name']} per tenir acc�s.",
