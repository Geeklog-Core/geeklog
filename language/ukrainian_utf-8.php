...
$LANG24 = array(
    ...
    39 => 'Пересилання',
    40 => '',
    41 => "Ви намагалися отримати доступ до статті, до якої в Вас немає прав. Ця спроба була записана. Ви можете лише прочитати статтю. Будь-ласка, <a href=\"{$_CONF['site_admin_url']}/article.php\"> поверніться на сторінку адміністрування  статтей </a> коли закінчите.",
    42 => "Ви намагалися отримати доступ до статті, до якої в Вас немає прав. Ця спроба була записана. Будь-ласка, <a href=\"{$_CONF['site_admin_url']}/article.php\">поверніться на сторінку адміністрування статтей</a>.",
    43 => '',
    44 => '',
    45 => '',
    ...
    78 => 'Натисніть <a href="%s/article.php?mode=edit&amp;sid=%s&amp;editopt=default">тут</a>, щоб використовувати звичайний редактор',
    79 => 'Перегляд',
    80 => 'Редактор',
    81 => 'Опції публікації',
    82 => 'Зображення',
...
$LANG32 = array(
    ...
    9 => 'Модуль потребує більш нової версії Geeklog. Оновіть Вашу копію <a href="https://www.geeklog.net">Geeklog</a> або спробуйте знайти іншу версію модуля.',
