...
$LANG04 = array(
	...
	66 => "Можливо Ви неправильно набрали пароль або ім'я користувача. Спробуйте ще раз увійти до системи.",
	67 => "Зареєстровано",
    ...
    95 => 'Оберіть "вилучити користувача", щоб видалити ваш обліковий запис із бази даних. Зауважте, що усі коментарі, надіслані вами під цим логіном <strong>не</strong> буде вилучено, а підписано іменем "Анонім".',
    ...
    118 => "Ваш обліковий запис на {$_CONF['site_name']} активовано адміністратором. Ви можете увійти на сайтза адресою, вказаною нижче, використовуючи ваш логін (<username>) і попередньо надісланий вам пароль.",
...
$LANG08 = array(
	...
	23 => "Цей лист надіслано вам %s з %s тому що він/вона вважали, що вас зацікавить ця стаття з {$_CONF['site_url']}. Це не СПАМ і електронні адреси, залучені в цю дію, не збережено для подальшого використання.",
...
$LANG10 = array(
    ...
    28 => '10 найпопулярніших подій',
    29 => 'Подія',
    30 => 'Хіти',
    31 => 'На цьому сайті немає подій, або ніхто не переглядав їх.'
);
...
$LANG21 = array(
	...
	23 => 'Порядок блоку',
	24 => '',
	25 => 'Щоб змінити або видалити блок, натисніть його іконку редагування нижче.  Щоб створити новий блок, натисніть "Створити нове" вгорі. Щоб перемістити блок, натискайте стрілки чи кнопки [R] та [L].',
	26 => 'Блок розміщення',
	27 => 'Блок PHP',
...
$LANG24 = array(
	...
	21 => 'Надіслати пінг',
	22 => 'Список статтей',
	23 => 'Щоб змінити чи видалити статтю, натисніть її іконку редагування нижче. Щоб переглянути статтю, натисніть її заголовок. Щоб створити нову статтю, оберіть "Створити нове" вгорі.',
	...
	28 => '<p><b>ПОПЕРЕДНІЙ ПЕРЕГЛЯД</b>: Переглядати статтю з малюнками найкраще робити, зберігаючи статтю як чорновик замість натискати кнопку перегляду.  Використовуйте цю кнопку лише коли малюнків немає.',
	29 => 'Трекбеки',
...
$LANG27 = array(
	...
	8 => "Менеджер тем",
	9 => 'Щоб змінити або видалити тему, натисніть її.  Щоб створити нову, оберіть "Створити нове" вгорі. В дужках записано ваш рівень доступу до кожної теми. Зірочка (*) відмічає тему за замовчуванням.',
...
$LANG33 = array(
    ...
    11 => 'Нова стрічка',
    12 => '',
    13 => 'Щоб змінити чи видалити стрічку, натисніть її іконку редагування нижче. Щоб створити нову, оберіть "Створити нове" вгорі.',
    14 => 'Заголовок',
    15 => 'Тип',
    16 => 'Ім\'я файла',
    17 => 'Формат',
...
$MESSAGE = array (
    ...
    63 => 'Під час видалення трекбек-коментаря сталася помилка.',
    64 => 'Ваш трекбек-коментар успішно відправлено.',
    65 => 'Службу Веблог успішно збережено.',
    66 => 'Службу Веблог успішно видалено.',
...
$LANG_TRB = array (
    ...
    'service_explain'    => 'Щоб змінити чи видалити службу, натисніть її іконку нижче. Щоб додати нову службу, натисніть "Створити нове" вгорі.',
    'service'            => 'Служба',
    ...
    'trackback_note'     => 'Щоб надіслати трекбек-коментар для статті, перейдіть до списку статей і натисніть "' . $LANG24[21] . '" біля статті. Щоб відправити трекбек, не пов\'язаний зі статтею, натисніть <a href="%s">тут</a>.',
    ...
    'pingback_note'      => 'Щоб надіслати пінгбек для статті, перейдіть до списку статей і натисніть "' . $LANG24[21] . '" біля статті. Щоб відправити пінгбек, не пов\'язаний зі статтею, натисніть <a href="%s">тут</a>.',
