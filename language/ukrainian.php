...
$LANG01 = array(
    ...
    57 => 'Пароль',
    58 => 'Логін',
    59 => "Ви ще не зареєструвалися? Зробіть це як <a href=\"{$_CONF['site_url']}/users.php?mode=new\">новий користувач</a>",
...
$LANG04 = array(
    ...
    151 => 'Попередній перегляд',
    152 => 'Ім\'я користувача та пароль',
    153 => 'Зовнішній вигляд та мова',
    154 => 'Вміст',
    155 => 'Приватність',
...
$LANG33 = array(
    ...
    37 => 'У вас встановлено принаймні один модуль, що підтримує експорт контенту. Нижче вам потрібно обрати, хочете ви створити стрічку Geeklog чи стрічку одного з модулів.',
