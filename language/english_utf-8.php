...
$LANG_ROUTER = array(
    ...
    20 => '<ul><li>Placeholders (@) must be the same both in a rule and its route.</li><li>A placeholder starts with "@", followed by an alphabet, optionally followed by any length of alphabet or digit.</li><li>Placeholders are case-sensitive.</li><li><strong>Status Code currently should be left at 200.</strong> Changing this may cause unforeseen issues as this feature is experimental.</li></ul>',
    21 => 'Status Code',
    22 => 'Enabled', 
    23 => 'Yes',
    24 => 'No'
