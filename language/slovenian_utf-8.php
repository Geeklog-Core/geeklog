...
$LANG08 = array(
    ...
    24 => 'Članek lahko komentiraš tukaj:',
    25 => 'Za uporabo te funkcije se je treba prijaviti. Prijava pomaga preprečevati morebitne zlorabe sistema.',
...
$LANG10 = array(
    ...
    25 => 'Deset najbolj s trackbacki komentiranih člankov',
...
$LANG21 = array(
    ...
    51 => 'začni s http://',
    52 => 'Če pustiš prazno, se ikona pomoči za ta blok ne bo prikazala!',
    53 => 'Omogočeno',
    54 => 'shrani',
    55 => 'prekliči',
    56 => 'izbriši',
    ...
    68 => 'Združena vsebina tega bloka je predolga za prikaz. Prosim, v nastavitvah bloka nastavi največje število člankov za uvoz ali nastavi najvišje število (global maximum) v nastavitvah Geekloga (Geeklog Configuration).'
);
...
$LANG24 = array(
    ...
    44 => '',
    45 => '',
    46 => '<b>OPOMBA:</b> Če tu nastaviš datum v prihodnosti, članek do tistega dne ne bo objavljen. Do tega datuma članka ne bo niti v RDF niti ne bo vključn v iskalnik in statistične strani.',
    47 => 'Slike',
    48 => 'slika',
    49 => 'desno',
    50 => 'levo',
...
$LANG28 = array(
    ...
    81 => 'Opomnik o preverbi računa za  %s',
    82 => "Tvoj račun na {$_CONF['site_name']} ni bil uporabljen od %s in bo onemogočen, če ga ne uporabiš v 30 dneh.",
    83 => "Tvoj račun na {$_CONF['site_name']} ni bil uporabljen odkar je bil ustvarjen in bo izbrisan kmalu, če ga ne uporabiš.",
    84 => "Tvoje uporabniško ime je: %s  za internetno stran: {$_CONF['site_url']}",
    85 => 'če si pozabil geslo, uporabi to povezavo: %s',
    86 => 'Vključi',
    87 => 'Opomniki',
    88 => 'Prednastavljena skupina',
    89 => 'Potrdi, da to postane prednastavljena skupina za nove uporabnike',
    90 => 'Vnesi spremembe "Prednastavljene skupine" obstoječim uporabniškim računom',
...
$LANG32 = array(
    ...
    38 => 'Posodobi!',
    39 => 'Naloži vtičnik',
    40 => 'Arhiv vtičnika (.tar.gz, .tgz, .zip) lahko naložiš neposredno tukaj:',
    41 => 'Naloži',
...
$MESSAGE = array(
    ...
    16 => 'Izpisali ste se. O odgovorih ne boste več obveščeni.',
    17 => '',
    18 => '',
    19 => '',
    20 => '',
    ...
    29 => 'Oprosti, do te uredniške strani nimaš dostopa. Vsi poskusi dostopa do nepooblaščenih funkcij se beležijo.',
    30 => 'Dostop zavrnjen',
    31 => '',
    32 => '',
    33 => '',
    ...
    73 => 'Med odstranjevanjem vtičnika je prišlo do napake. Za podrobnosti glej error.log.',
    ...
    96 => '',
    97 => '',
    98 => 'Vtičnik je bil uspešno naložen.',
    99 => 'Vtičnik že obstaja.',
    100 => 'Naložena vtičniška datoteka ni bila stisnjena kot arhiv GZip ali Zip.',
    101 => 'Ni rubrik (do katerih imaš dostop). Za oddajo članka potrebuješ vsaj eno rubriko.',
...
$LANG_ACCESS = array(
    ...
    'newgroupmsg' => 'Za spreminjanje ali izbris skupine klikni na njeno ikono za urejanje spodaj. Če hočeš oblikovati novo skupino, klikni na "Ustvari" zgoraj. Jedrnih skupin ni mogoče odstraniti, ker jih uporablja sistem.',
    ...
    'group_id' => 'ID skupine',
    'plugin_access_denied_msg' => 'Nedovoljeno poskušaš dostopiti do strani za skrbništvo vtičnikov. Vsi poskusi dostopa do nepooblaščenih funkcij se beležijo.',
...
$LANG_DB_BACKUP = array(
    ...
    'delete_failure' => 'Ene ali več datotek varnostnih kopij se ni dalo izbrisati.',
    ...
    'innodb_explain' => 'InnoDB tabele omogočajo hitrejšo obdelavo pri <em>zelo</em> velikih podatkovnih bazah, vendar otežijo postopek varnostnega kopiranja. Prosim, <a href="http://dev.mysql.com/doc/mysql/en/innodb.html">preberi</a> razloge za in proti InnoDB tabelam, preden izvedeš ta postopek.',
    'already_converted' => 'Opomba: Videti je, da so že vse tabele pretvorjene v InnoDB.',
    'conversion_patience' => 'Opomba: Pretvorba lahko traja nekaj časa. Prosim, bodi potrpežljiv.',
...
$LANG_DIR = array(
    'title' => 'Seznam člankov',
    'title_year' => 'Seznam člankov za %d',
    'title_month_year' => 'Seznam člankov za %s %d',
    'nav_top' => 'Nazaj na seznam člankov',
...
$LANG_SECTEST = array(
    ...
    'please_fix' => 'Prosim, popravi zgoraj navedene zadeve, preden začneš uporabljati stran!',
    'please_note' => 'Zavedaj se prosim, da nobena stran ni nikoli 100% varna. Ta skripta lahko testira le očitne varnostne zadeve.',
    'stay_informed' => 'Da ostaneš obveščen/a o novih izdajah in morebitnih varnostnih zadevah Geekloga, predlagamo, da se vpišeš na (low-traffic) %s mailing listo in/ali občasno uporabiš možnost %s v svojem administratorskem meniju in preveriš posodobitve, ki so na voljo.',
    ...
    'failed_tmp' => 'Ustvarjenje začasne datoteke v direktoriju %s je spodletelo. Preveri svoje pravice za direktorij!',
    ...
    'remove_inst2' => 'Ohranitev tega direktorija bi zlonamernim uporabnikom omogočila, da uničijo trenutno namestitev, prevzamejo stran ali pridejo do občutljivih podatkov.',
    ...
    'password_okay' => 'Dobro! Izgleda, da je prednastavljeno geslo računa že spremenjeno.'
);
...
$LANG_ADMIN = array(
    ...
    'unavailable' => 'N/A',
    'warning' => '!!!',
    'token_expiry' => 'Spremembe lahko narediš do %s. Po tem času bo varnostni žeton (token), vstavljen v to stran, potekel in spremembe bodo izgubljene.',
...
$LANG_CONFIG = array(
    ...
    'disable' => 'Klikni, da to izbiro onemogočiš',
    'enable' => 'Omogoči',
...
$LANG_confignames['Core'] = array(
    ...
    'directoryloginrequired' => 'Zahtevana prijava za Seznam člankov?',
    ...
    'comment_edittime' => 'Čas urejanja komentarjev (sekunde)',
    'commentsubmission' => 'Omogoči vrsto za komentarje',
    ...
    'skip_html_filter_for_root' => 'Preskoči HTML filtriranje za Koren (Root)?',
    'allowed_protocols' => 'Dovoljeni protokoli',
    'disable_autolinks' => 'Onemogoči samodejne povezave (Autotags)?',
    ...
    'disable_webservices' => 'Onemogoči Spletne storitve?',
    ...
    'comment_close_rec_stories' => 'Število najnovejših člankov, omogočenih za komentiranje',
    ...
    'search_separator' => 'Ločevalnik skupin',
...
$LANG_configsubgroups['Core'] = array(
    ...
    'sg_stories' => 'Članki in trackbacki',
    'sg_theme' => 'Postavitev',
    'sg_blocks' => 'Bloki',
