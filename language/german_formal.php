...
$LANG04 = array(
    ...
    14 => 'Dieses Passwort wurde mit einem Zufallsgenerator erzeugt. Es wird empfohlen, das Passwort nach dem Anmelden sofort zu �ndern. Um Ihr Passwort zu �ndern, melden Sie sich bitte an und w�hlen dann den Punkt Ihr Profil im Block Einstellungen.',
    ...
    29 => 'ausgeloggt von',
    30 => 'eingeloggt von',
    31 => 'Um diese Funktion nutzen zu k�nnen, m�ssen Sie angemeldet sein',
    32 => 'Signatur',
    ...
    98 => 'Sind Sie sicher, dass Sie Ihren Account l�schen wollen? Sie werden sich danach nicht mehr anmelden k�nnen (es sei denn, Sie legen einen neuen Account an). Wenn Sie sich sicher sind, klicken Sie bitte noch einmal auf "Account L�schen".',
    ...
    127 => 'Um diese Angaben zu �ndern m�ssen Sie Ihr aktuelles Passwort eingeben.',
    128 => 'Ihr Name',
    129 => 'Passwort &amp; E-Mail',
    130 => 'Informationen �ber Sie',
    ...
    140 => '<li>Kategorien ohne Icons: Wenn angekreuzt werden in Artikeln keine Icons mehr angezeigt.</li><li>Keine Bl�cke: Wenn angekreuzt werden nur noch die Bl�cke Einstellungen, Kategorien und der Admin-Block angezeigt.<li>Einstellung f�r die maximale Anzahl von Artikeln pro Seite.</li><li>W�hlen Sie das Erscheinungsbild der Website, Ihre Zeitzone und das bevorzugte Datumsformat.</li>',
    141 => 'Privatsph�re',
    142 => 'Hier k�nnen Sie einstellen, ob Ihnen andere User und Admins E-Mails schicken k�nnen und ob Sie im Block "Wer ist online?" namentlich oder nur anonym erscheinen wollen.',
    143 => 'Bl�cke anzeigen',
    144 => 'Bl�cke anzeigen',
    145 => 'Vorschau: So sieht Ihr Profil aus',
    146 => 'Passwort &amp; E-Mail',
    147 => 'Hier k�nnen Sie Ihr Passwort und Ihre E-Mail-Adresse �ndern sowie bestimmen, wie lange Sie eingeloggt bleiben wollen. Passwort und E-Mail m�ssen zum �ndern zweimal eingegeben werden.',
    148 => 'Informationen �ber Sie',
    149 => 'Hier k�nnen Sie eingeben, was andere User �ber Sie sehen k�nnen:<ul><li>Die Signatur wird an Kommentare angef�gt</li><li>In der Biographie k�nnen Sie etwas �ber sich erz�hlen</li><li>Sie k�nnen Ihren PGP-Key hinterlegen</li></ul>',
    150 => '',
    151 => 'Blocks',
    156 => 'Account l�schen',
    157 => 'L�schen',
...
$LANG24 = array(
    ...
    26 => 'Artikelvorschau',
    27 => '<p>Wenn Sie [unscaledX] statt [imageX] verwenden, wird das Bild in Originalgr��e eingebunden.',
    ...
    39 => 'E-Mails',
    40 => '',
    41 => "Sie haben keine Zugriffsrechte f�r diesen Artikel. Dieser Zugriffsversuch wurde protokolliert. Sie k�nnen sich den Artikel aber ansehen (s.u., �ndern nicht m�glich). <a href=\"{$_CONF['site_admin_url']}/article.php\">Zur�ck zum Administrator-Men�</a>.",
    42 => "Sie haben keine Zugriffsrechte f�r diesen Artikel. Dieser Zugriffsversuch wurde protokolliert. <a href=\"{$_CONF['site_admin_url']}/article.php\">Zur�ck zum Administrator-Men�</a>.",
    43 => '',
    44 => '',
    45 => '',
    ...
    90 => 'Metatag Keywords',
    91 => 'Sie k�nnen aber jederzeit auf "Vorschau" klicken, um diese Zeit zu verl�ngern.',
...
$LANG27 = array(
    ...
    8 => 'Kategorie-Manager',
    9 => 'Auf eine Kategorie klicken, um sie zu �ndern oder zu l�schen. Auf Neu anlegen (s.o.) klicken, um eine neue Kategorie anzulegen. Die n�tige Zugriffsberechtigung wird in Klammern hinter der Kategorie angegeben. Das Sternchen(*) markiert die voreinstellte Kategorie.',
...
\n    ",
    ...
    83 => "Ihr Account auf der Seite {$_CONF['site_name']} wurde seit der Einrichtung nicht benutzt und wird gel�scht, wenn Sie nicht in K�rze einloggen.",
...
$LANG32 = array(
    ...
    68 => 'Sie haben nicht die n�tigen Rechte, um Plugins installieren zu k�nnen.',
    69 => 'Sie haben nicht die n�tigen Rechte, um Plugins hochladen zu k�nnen.',
...
$MESSAGE = array(
    ...
    2 => "Danke f�r Ihren Beitrag zu {$_CONF['site_name']}. Der Artikel wurde an unser Team weitergeleitet. Wenn er akzeptiert wird, wird er bald auf dieser Website f�r alle Besucher zu lesen sein.",
    3 => '',
    4 => '',
    ...
    16 => 'Abonnement wurde gel�scht. Sie werden nicht l�nger �ber Antworten benachrichtigt.',
    ...
    77 => 'HINWEIS:<br' . XHTML . '>Sie haben UTF-8 als Standard-Zeichensatz angegeben. Ihr Webserver unterst�tzt jedoch kein "multibyte encoding". Installieren Sie bitte die mbstring-Erweiterung f�r PHP oder benutzen Sie einen anderen Zeichensatz bzw. eine andere Sprache.',
    ...
    82 => 'Sie haben die erlaubte Anzahl von Anmeldeversuchen �berschritten. Bitte versuchen Sie es sp�ter noch einmal.',
    83 => 'Um Ihr Passwort, Ihre E-Mail-Adresse oder die "Angemeldet f�r"-Zeit zu �ndern m�ssen Sie Ihr aktuelles Passwort eingeben.',
    84 => 'Um den Account zu l�schen, bitte aktuelles Passwort eingeben.',
    85 => 'Es gab ein Problem, die E-Mail zu senden.',
    86 => 'Der OpenID-Server erkl�rte Ihren Einlogversuch f�r ung�ltig.',
    ...
    92 => "Bitte <a href=\"{$_CONF['site_admin_url']}/sectest.php\">die Sicherheit Ihrer Site �berpr�fen</a> bevor Sie sie benutzen!",
    93 => 'Datenbank-Backup war erfolgreich.',
    94 => 'Backup hat nicht geklappt: Dateigr��e unter 1kb',
    ...
    101 => 'Es gibt keine Kategorien (, auf die Sie Zugriff haben). Es bedarf mindestens einer Kategorie, um Beitr�ge zu schreiben.',
...
$LANG_ACCESS = array(
    ...
    'storydenialmsg' => "Sie haben nicht die n�tigen Rechte, um diesen Artikel zu lesen. M�glicherweise sind Sie kein registrierter User von {$_CONF['site_name']}. Bitte melden Sie sich als <a href=\"{$_CONF['site_url']}/users.php?mode=new\" rel=\"nofollow\">neuer User</a> von {$_CONF['site_name']} an um vollen Zugriff auf alle Bereiche zu bekommen.",
...
$LANG_TRB = array(
    ...
    'service_explain' => 'Um ein Weblog-Verzeichnis zu �ndern oder zu l�schen, auf das �ndern-Symbol klicken. Um ein neues Weblog-Verzeichnis einzutragen, auf Neu anlegen (s.o.) klicken.',
    'service' => 'Verzeichnis',
    ...
    'trackback_note' => 'Um einen Trackback-Kommentar f�r einen Artikel zu verschicken, benutzen Sie bitte den "Ping"-Eintrag in der Liste der Artikel. Um einen Trackback unabh�ngig von einem Artikel zu verschicken, bitte <a href="%s">hier klicken</a>.',
    ...
    'pingback_note' => 'Um einen Pingback f�r einen Artikel zu verschicken, benutzen Sie bitte den "Ping"-Eintrag in der Liste der Artikel. Um einen Pingback unabh�ngig von einem Artikel zu verschicken, bitte <a href="%s">hier klicken</a>.',
...
$LANG_ADMIN = array(
    ...
    'reauth_msg' => 'Das Security-Token f�r diese Ver�nderung ist ausgelaufen. Wenn Sie weitermachen wollen, dann bitte unten neu authentifizieren. Damit wird sichergestellt, dass die gerade gemachten �nderungen nicht verloren gehen.',
