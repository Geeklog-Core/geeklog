...
$LANG01 = array(
   ...
   57 => '비밀번호',
   58 => '로그인',
   59 => "<a href=\"{$_CONF['site_url']}/users.php?mode=new\">신규등록</a>",
   60 => '덧글달기',
   61 => '어카운트 작성',
   62 => '워드',
   63 => '덧글설정',
   ...
   117 => '전체글',
   118 => '다음장으로',
   119 => "<a href=\"{$_CONF['site_url']}/users.php?mode=getpassword\">비밀번호 재발행</a> ",
   120 => '이 덧글에 대한 영구링크',
   121 => '덧글 (%d 건)',
   122 => '트랙백 (%d 건)',
...
$LANG04 = array(
   ...
   71 => "{$_CONF['site_name']}의 특징으로, 표시된 글의 화제와 표시를 자유로 바꿀 수 있습니다. 그러기 위해서는 우선, {$_CONF['site_name']}에<a href=\"{$_CONF['site_url']}/users.php?mode=new\">사용자 등록</a>할 필요가 있습니다.  이미 등록을 마쳤다면 왼쪽 양식으로 로그인 바랍니다.",
   72 => '화제',
   73 => '말',
   74 => '이 사이트의 디자인 변경',
   ...
   123 => "<a href=\"{$_CONF['site_url']}/users.php?mode=new\">신규등록</a>",
   124 => '(확인) 메일주소',
...
$LANG_ACCESS = array(
   ...
   'none' => '없슴',
   'accessdenied' => '접속 실패.',
   'storydenialmsg' => "이 기사를 검색할 권한이 없습니다.  이것은 당신이{$_CONF['site_name']}의 멤버가 아니기 때문인 것으로 여겨집니다. {$_CONF['site_name']} 의<a href=users.php?mode=new> 멤버가 되면 </a>으로 검색 할 수 있습니다.",
...
$LANG_DB_BACKUP = array(
   ...
   'no_backups' => '시스템에 백업이 없습니다',
   'db_explanation' => 'Geeklog를 백업하기 위해서는 다음의 단추를 클릭하시기 바랍니다.',
   'not_found' => "패스 지정에 잘못이 있으므로 mysqdump가 실행 가능해지지 않습니다.<br><strong>\$_DB_mysqldump_path</strong>의 설정을 config.php로 체크하시기 바랍니다.  <br> 현재의 설정은 \n<var>{$_DB_mysqldump_path}</var>입니다.",
...
$LANG_TRB = array (
   ...
   'trackback_note'     => '기사에 트랙백을 보내기 하려면, 기사일람으로 그 기사의"' . $LANG24[21] . '"을 클릭하시기 바랍니다. 기사와 관계없는 트랙백을 보내기 하면 <a href="%s">이곳을 클릭</a>。',
   'pingback_explain'   => '핑백 하는 URL을 입력하시기 바랍니다.  핑 백에서 다른 사이트로 부터 링크가 늘어난 것을 자동적으로 통지 합니다.',
   'pingback_url'       => '핑백 URL',
   'site_url'           => '이 사이트의 URL',
   'pingback_note'      => '기사에 대한 핑백을 보내기 하기 위해서는 기사를 클릭 하시기 바랍니다."' .$LANG24[21] . '" 에 관련 있는 기사에 핑을 보내기 하기 위해서는<a href="%s">여기를 클릭</a>.',
