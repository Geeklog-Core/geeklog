...
$LANG32 = array(
    ...
    9 => 'Αυτό το εξωτερικό πρόγραμμα απαιτεί νεότερη έκδοση του Geeklog. Η αναβαθμίστε την έκδοση σας του <a href="https://www.geeklog.net">Geeklog</a> η βρείτε μία νεότερη έκδοση του.',
