...
$LANG03 = array(
    ...
    20 => 'Beziehe Dich mï¿½glichst auf Kommentare anderer Personen statt einen neuen Thread zu erï¿½ffnen.',
    ...
    23 => 'Deine E-Mail-Adresse wird NICHT verï¿½ffentlicht.',
...
$LANG04 = array(
    ...
    14 => 'Dieses Passwort wurde mit einem Zufallsgenerator erzeugt. Es wird empfohlen, das Passwort nach dem Anmelden sofort zu ï¿½ndern. Um Dein Passwort zu ï¿½ndern, melde Dich bitte an und wï¿½hle dann den Punkt Mein Profil im Block Einstellungen.',
    15 => "Dein Account fï¿½r {$_CONF['site_name']} wurde erfolgreich angelegt. Um ihn benutzen zu kï¿½nnen, melde Dich bitte mit den folgenden Informationen an. Diese E-Mail bitte aufheben.",
    ...
    23 => "Indem Du Dich bei {$_CONF['site_name']} anmeldest, kannst Du Artikel und Kommentare unter Deinem eigenen Namen verï¿½ffentlichen (andernfalls geht das nur anonym). ï¿½brigens wird Deine E-Mail-Adresse <strong><em>niemals</em></strong> auf dieser Website angezeigt werden.",
    ...
    29 => 'ausgeloggt von',
    30 => 'eingeloggt von',
    31 => 'Um diese Funktion nutzen zu kï¿½nnen, musst Du angemeldet sein',
    32 => 'Signatur',
    33 => 'Auf der Site nicht sichtbar!',
    34 => 'Dein richtiger Name',
    35 => 'Passwort eingeben, um es zu ï¿½ndern',
    36 => '(mit http://)',
    37 => 'Wird an Deine Kommentare angefï¿½gt',
    38 => 'Alles ï¿½ber Dich - fï¿½r alle sichtbar',
    ...
    50 => 'Hï¿½kchen entfernen, wenn es Dich nicht interessiert',
    51 => 'Nur die Artikel',
    52 => 'Grundeinstellung:',
    53 => 'Artikel jede Nacht empfangen',
    54 => 'Kategorien und Autoren auswï¿½hlen, die Du NICHT sehen willst.',
    55 => 'Wenn Du hier nichts ankreuzt, wird die Default-Auswahl an Blï¿½cken angezeigt. Sobald Du anfï¿½ngst, Blï¿½cke anzukreuzen, werden auch nur noch diejenigen angezeigt, die angekreuzt sind! Die Default-Blï¿½cke sind <b>fett</b> markiert.',
    56 => 'Autoren',
    57 => 'Anzeigemodus',
    ...
    62 => 'Defaultwert: 100',
    63 => "Dein Passwort sollte in Kï¿½rze per E-Mail eintreffen. Bitte beachte die Hinweise in der E-Mail und Danke fï¿½r Dein Interesse an {$_CONF['site_name']}",
    ...
    71 => "Zu den Features von {$_CONF['site_name']} gehï¿½rt, dass Du selbst festlegen kannst, welche Artikel Du angezeigt bekommst. Darï¿½ber hinaus kannst Du auch das Aussehen der Website verï¿½ndern. Um in den Genuss dieser Features zu kommen, musst Du Dich jedoch zuerst bei {$_CONF['site_name']} <a href=\"{$_CONF['site_url']}/users.php?mode=new\" rel=\"nofollow\">anmelden</a>. Oder bist Du schon angemeldet? Dann benutze bitte das Anmeldeformular auf der linken Seite.",
    72 => 'Erscheinungsbild',
    73 => 'Sprache',
    74 => 'ï¿½ndere das Aussehen dieser Site',
    75 => 'Artikel per E-Mail fï¿½r',
    76 => 'Wï¿½hle Kategorien aus der folgenden Liste und Du bekommst einmal pro Tag eine E-Mail mit einer ï¿½bersicht aller neuen Artikel in den ausgewï¿½hlten Kategorien. Du brauchst nur die Kategorien anzukreuzen, die Dich interessieren.',
    77 => 'Foto',
    78 => 'Ein Bild von Dir',
    ...
    87 => 'Dein Username',
    88 => "Jemand (mï¿½glicherweise Du selbst) hat ein neues Passwort fï¿½r Deinen Account \"%s\" auf {$_CONF['site_name']} <{$_CONF['site_url']}> angefordert.\n\nWenn Du tatsï¿½chlich ein neues Passwort benï¿½tigst, klicke bitte auf den folgenden Link:\n\n",
    89 => "Mï¿½chtest Du Dein Passwort nicht ï¿½ndern, so kannst Du diese E-Mail einfach ignorieren (Dein bisheriges Passwort bleibt dann unverï¿½ndert gï¿½ltig).\n\n",
    90 => 'Du kannst hier jetzt ein neues Passwort fï¿½r Deinen Account eingeben. Dein altes Passwort bleibt noch solange gï¿½ltig, bis Du dieses Formular abschickst.',
    91 => 'Neues Passwort',
    92 => 'Neues Passwort eingeben',
    93 => 'Du hast zuletzt vor %d Sekunden ein neues Passwort angefordert. Zwischen zwei Passwort-Anforderungen mï¿½ssen aber mindestens %d Sekunden vergangen sein.',
    94 => 'Lï¿½sche Account "%s"',
    96 => 'Account lï¿½schen',
    97 => 'Account lï¿½schen bestï¿½tigen',
    98 => 'Bist Du sicher, dass Du Deinen Account lï¿½schen willst? Du wirst Dich danach nicht mehr einloggen kï¿½nnen (es sei denn, Du legst einen neuen Account an). Wenn Du Dir sicher bist, klicke bitte noch einmal auf "Account Lï¿½schen".',
    ...
    112 => 'Du hast die erlaubte Anzahl von Anmeldeversuchen ï¿½berschritten. Bitte versuche es spï¿½ter noch einmal.',
    ...
    118 => "Dein Account fï¿½r {$_CONF['site_name']} wurde jetzt freigeschaltet. Du kannst Dich jetzt auf der Website unter der unten angegebenen URL anmelden. Benutze dazu Deinen Usernamen (<username>) und das Passwort, das Du bereits per E-Mail erhalten hast.",
    119 => 'Wenn Du Dein Passwort vergessen hast, kannst Du unter der folgenden URL ein neues anfordern:',
    120 => 'Account aktiviert',
    121 => 'Dienst',
    122 => 'Sorry, derzeit kï¿½nnen sich keine neuen User anmelden.',
    ...
    127 => 'Um diese Angaben zu ï¿½ndern musst Du Dein aktuelles Passwort eingeben.',
    128 => 'Dein Name',
    129 => 'Passwort &amp; E-Mail',
    130 => 'ï¿½ber Dich',
    ...
    140 => '<li>Kategorien ohne Icons: Wenn angekreuzt werden in Artikeln keine Icons mehr angezeigt.</li><li>Keine Blï¿½cke: Wenn angekreuzt werden nur noch die Blï¿½cke Einstellungen, Kategorien und der Admin-Block angezeigt.<li>Einstellung fï¿½r die maximale Anzahl von Artikeln pro Seite.</li><li>Wï¿½hle das Erscheinungsbild der Website, Deine Zeitzone und das bevorzugte Datumsformat.</li>',
    141 => 'Privatsphï¿½re',
    142 => 'Per Grundeinstellung ist es Admins und anderen Usern der Site erlaubt, Dir E-Mails zu schicken sowie Deinen Status unter "Wer Ist Online?" zu sehen. Hier kannst Du diese Einstellungen ï¿½ndern.',
    143 => 'Blï¿½cke anzeigen',
    144 => 'Blï¿½cke anzeigen',
    145 => 'Vorschau: So sieht Dein Profil aus',
    146 => 'Passwort &amp; E-Mail',
    147 => 'Hier kannst Du Dein Passwort und Deine E-Mai-Adresse ï¿½ndern sowie bestimmen, wie lange Du eingeloggt bleiben willst. Passwort und E-Mail mï¿½ssen zum ï¿½ndern zweimal eingegeben werden.',
    148 => 'ï¿½ber Dich',
    149 => 'Hier kannst Du eingeben, was andere User ï¿½ber Dich sehen kï¿½nnen:<ul><li>Die Signatur wird an Kommentare angefï¿½gt</li><li>In der Biographie kannst Du etwas ï¿½ber Dich erzï¿½hlen</li><li>Du kannst Deinen PGP-Key hinterlegen</li></ul>',
    150 => '',
    151 => 'Blocks',
...
$LANG08 = array(
    ...
    3 => 'Bitte sicherstellen, dass Du eine gï¿½ltige E-Mail-Adresse eingetragen hast.',
    4 => 'Bitte alle Felder ausfï¿½llen: Dein Name, Deine E-Mail, Betreff und Nachricht',
    ...
    23 => "Diese Nachricht wurde Dir von %s <%s> geschickt, da er/sie der Meinung war, Du wï¿½rdest Dich vielleicht fï¿½r diesen Artikel auf <{$_CONF['site_url']}> interessieren. Dies ist kein Spam und die beteiligten E-Mail-Adressen (Deine und die des Absenders) wurden nicht gespeichert.",
    24 => 'Schreibe einen Kommentar zu diesem Artikel:',
    25 => 'Du musst Dich anmelden, um diese Funktion benutzen zu kï¿½nnen. Dies ist leider nï¿½tig, um den Missbrauch des Systems zu verhindern',
    26 => 'Mit diesem Formular kannst Du eine E-Mail an diesen User schicken. Alle Felder mï¿½ssen ausgefï¿½llt werden.',
    27 => 'Kurze Nachricht',
    28 => '%s schrieb: ',
...
$LANG12 = array(
    ...
    8 => 'Abschicken',
    9 => 'Wenn Du Informationen einreichen mï¿½chtest, die auf dieser Site verï¿½ffentlicht werden sollen, dann bitten wir Dich, folgende Punkte zu beachten:<ul><li>Bitte alle Felder ausfï¿½llen, sie werden benï¿½tigt<li>Bitte nur vollstï¿½ndige und exakte Informationen einreichen<li>URLs vor dem Abschicken unbedingt noch einmal kontrollieren</ul>',
    10 => 'Titel',
    11 => '',
    12 => 'Startdatum',
    13 => 'Enddatum',
...
$LANG21 = array(
    ...
    2 => 'Du hast nicht die nï¿½tigen Rechte, um diesen Block ï¿½ndern zu kï¿½nnen.',
    3 => 'Block-Editor',
    ...
    29 => 'Block-Funktion',
    30 => 'Wenn einer Deiner Blï¿½cke PHP-Code verwenden soll, gib hier bitte den Namen der Funktion ein. Der Funktionsname muss mit "phpblock_" (z.B. phpblock_getweather) beginnen. Wenn sie diese Namenskonvention nicht einhï¿½lt, wird die Funktion NICHT aufgerufen. Das soll verhindern, dass Hacker evtl. gefï¿½hrlichen Code einschleusen kï¿½nnen. Den Funktionsnamen NICHT mit einem Klammerpaar "()" abschliessen. Ferner wird empfohlen, all Deinen Code fï¿½r PHP-Blï¿½cke in der Datei /pfad/zu/geeklog/system/lib-custom.php abzulegen. Dort kann der Code auch dann unverï¿½ndert bleiben, wenn Du auf eine neuere Geeklog-Version umsteigst.',
    ...
    44 => 'Multiple',
    45 => "Du hast keine Zugriffsrechte fï¿½r diesen Block. Dieser Zugriffsversuch wurde protokolliert. <a href=\"{$_CONF['site_admin_url']}/block.php\">Zurï¿½ck zum Administrator-Menï¿½</a>.",
    46 => 'Bewegen',
    47 => 'None',
    48 => 'Block-Name',
...
$LANG24 = array(
    ...
    26 => 'Artikelvorschau',
    27 => '<p>Wenn Du [unscaledX] statt [imageX] verwendest, wird das Bild in Originalgrï¿½ï¿½e eingebunden.',
    ...
    39 => 'E-Mails',
    40 => '',
    41 => "Du hast keine Zugriffsrechte fï¿½r diesen Artikel. Dieser Zugriffsversuch wurde protokolliert. Du kannst Dir den Artikel aber ansehen (s.u., ï¿½ndern nicht mï¿½glich). <a href=\"{$_CONF['site_admin_url']}/article.php\">Zurï¿½ck zum Administrator-Menï¿½</a>.",
    42 => "Du hast keine Zugriffsrechte fï¿½r diesen Artikel. Dieser Zugriffsversuch wurde protokolliert. <a href=\"{$_CONF['site_admin_url']}/article.php\">Zurï¿½ck zum Administrator-Menï¿½</a>.",
    43 => '',
    44 => '',
    45 => '',
    46 => '<b>HINWEIS:</b> Wenn Du hier ein Datum in der Zukunft einstellst, wird der Artikel erst verï¿½ffentlicht, wenn dieser Zeitpunkt erreicht ist. Bis dahin wird der Artikel auch nicht in der RSS-Datei, der Suche und der Statistik erscheinen.',
    47 => 'Bilder',
    48 => 'image',
    49 => 'right',
    50 => 'left',
    51 => '<p>Die oben ausgewï¿½hlten Bilder kï¿½nnen im Artikel verwendet werden, indem dafï¿½r spezielle Platzhalter in den Text eingefï¿½gt werden. Diese Platzhalter sind [imageX], [imageX_right] und [imageX_left], wobei statt des X jeweils die Nummer des Bildes eingetragen werden muss.<br' . XHTML . '>HINWEIS: Es mï¿½ssen alle ausgewï¿½hlten Bilder verwendet werden. Andernfalls kann der Artikel nicht gespeichert werden.<br' . XHTML . '>',
    52 => '',
    53 => 'wurde nicht verwendet. Du musst dieses Bild im Text des Artikels verwenden oder es lï¿½schen bevor Du Deine ï¿½nderungen sichern kannst.',
    ...
    90 => 'Metatag Keywords',
    91 => 'Du kannst aber jederzeit auf "Vorschau" klicken, um diese Zeit zu verlï¿½ngern.',
...
$LANG27 = array(
    ...
    8 => 'Kategorie-Manager',
    9 => 'Auf eine Kategorie klicken, um sie zu ï¿½ndern oder zu lï¿½schen. Auf Neu anlegen (s.o.) klicken, um eine neue Kategorie anzulegen. Die nï¿½tige Zugriffsberechtigung wird in Klammern hinter der Kategorie angegeben. Das Sternchen(*) markiert die Default-Kategorie.',
    10 => 'Sortierreihenfolge',
    11 => 'Artikel/Seite',
    12 => 'Zugriff verweigert',
    13 => "Du hast keine Zugriffsrechte fï¿½r diese Kategorie. Dieser Zugriffsversuch wurde protokolliert. <a href=\"{$_CONF['site_admin_url']}/topic.php\">Zurï¿½ck zum Administrator-Menï¿½</a>.",
    14 => 'Sortiermethode',
    15 => 'alphabetisch',
    16 => 'Grundeinstellung:',
    17 => 'Neue Kategorie',
...
$LANG28 = array(
    ...
    83 => "Dein Account auf der Seite {$_CONF['site_name']} wurde seit der Einrichtung nicht benutzt und wird gelï¿½scht, wenn Du nicht in Kï¿½rze einloggst.",
...
$LANG31 = array(
    ...
    18 => 'An',
    19 => 'HINWEIS: Wenn Du eine Nachricht an alle eingetragenen Benutzer schicken willst, musst Du die Gruppe Logged-in Users auswï¿½hlen.',
    20 => "<successcount> Nachricht(en) erfolgreich verschickt, bei <failcount> Nachricht(en) traten Fehler auf. Details kï¿½nnen der folgenden Liste entnommen werden. Du kannst jetzt <a href=\"{$_CONF['site_admin_url']}/mail.php\">noch eine Nachricht schicken</a> oder <a href=\"{$_CONF['site_admin_url']}/moderation.php\">zurï¿½ck zum Admin-Menï¿½ gehen</a>.",
    21 => 'Fehler',
    22 => 'Erfolgreich',
    23 => 'Keine Fehler',
...
$LANG32 = array(
    ...
    7 => 'Das Plugin, das Du installieren willst, ist schon vorhanden. Bitte lï¿½sche es, bevor Du noch einmal versuchst, es zu installieren',
    ...
    68 => 'Du hast nicht die nï¿½tigen Rechte, um Plugins installieren zu kï¿½nnen.',
    69 => 'Du hast nicht die nï¿½tigen Rechte, um Plugins hochladen zu kï¿½nnen.',
...
$MESSAGE = array(
    1 => "Dein Passwort sollte in Kï¿½rze per E-Mail bei Dir eintreffen. Bitte beachte die Hinweise in der E-Mail. Danke, dass Du Dich bei {$_CONF['site_name']} angemeldet hast.",
    2 => "Danke fï¿½r Deinen Beitrag zu {$_CONF['site_name']}. Der Artikel wurde an unser Team weitergeleitet. Wenn er akzeptiert wird, wird er bald auf dieser Website fï¿½r alle Besucher zu lesen sein.",
    3 => '',
    4 => '',
    ...
    16 => 'Abonnement wurde gelï¿½scht. Du wirst nicht lï¿½nger ï¿½ber Antworten benachrichtigt.',
    ...
    48 => "Danke, dass Du dich bei {$_CONF['site_name']} angemeldet hast. Dein Aufnahmeantrag wird von unserem Team geprï¿½ft. Sobald er akzeptiert wird, wirst Du Dein Passwort per E-Mail erhalten.",
    49 => 'Die Gruppe wurde gespeichert.',
    50 => 'Die Gruppe wurde gelï¿½scht.',
    51 => 'Dieser Username ist schon vergeben. Bitte wï¿½hle einen anderen.',
    ...
    54 => 'Diese Anfrage fï¿½r ein neues Passwort ist nicht mehr gï¿½ltig. Bitte fordere erneut ein neues Passwort an.',
    55 => 'Du solltest in Kï¿½rze eine E-Mail erhalten, in der beschrieben wird, wie Du ein neues Passwort fï¿½r Deinen Account eingeben kannst.',
    56 => 'Die angegebene E-Mail-Adresse wird schon fï¿½r einen anderen Account verwendet.',
    57 => 'Dein Account wurde gelï¿½scht.',
    ...
    71 => 'Dein Account wurde bestï¿½tigt, muss aber noch freigeschaltet werden.',
    ...
    76 => 'Willst Du diesen Eintrag wirklich lï¿½schen?',
    77 => 'HINWEIS:<br' . XHTML . '>Du hast UTF-8 als Standard-Zeichensatz angegeben. Dein Webserver unterstï¿½tzt jedoch kein "multibyte encoding". Installiere bitte die mbstring-Erweiterungen fï¿½r PHP oder benutze einen anderen Zeichensatz bzw. eine andere Sprache.',
    ...
    82 => 'Du hast die erlaubte Anzahl von Anmeldeversuchen ï¿½berschritten. Bitte versuche es spï¿½ter noch einmal.',
    83 => 'Um das Passwort, die E-Mail-Adresse oder die "Angemeldet fï¿½r"-Zeit zu ï¿½ndern mï¿½sst Du das aktuelle Passwort eingeben.',
    84 => 'Um den Account zu lï¿½schen, bitte aktuelles Passwort eingeben.',
    85 => 'Es gab ein Problem, die E-Mail zu senden.',
    86 => 'Der OpenID-Server erklï¿½rte Deinen Einlogversuch fï¿½r ungï¿½ltig.',
    ...
    92 => "Bitte <a href=\"{$_CONF['site_admin_url']}/sectest.php\">die Sicherheit Deiner Site ï¿½berprï¿½fen</a> bevor Du sie benutzt!",
    93 => 'Database back up war erfolgreich.',
    94 => 'Backup Failed: Dateigrï¿½ï¿½e unter 1kb',
    ...
    101 => 'Es gibt keine Kategorien (auf die Du Zugriff hast). Es bedarf mindestens einer Kategorie, um Beitrï¿½ge zu schreiben.',
...
$LANG_ACCESS = array(
    ...
    'storydenialmsg' => "Du hast nicht die nï¿½tigen Rechte, um diesen Artikel zu lesen. Mï¿½glicherweise bist Du kein registrierter User von {$_CONF['site_name']}. Bitte melde Dich als <a href=\"{$_CONF['site_url']}/users.php?mode=new\" rel=\"nofollow\">neuer User</a> von {$_CONF['site_name']} an um vollen Zugriff auf alle Bereiche zu bekommen.",
    ...
    'cancel' => 'Abbruch',
    'delete' => 'Lï¿½schen',
    'canteditroot' => 'Du hast versucht die Gruppe Root zu ï¿½ndern, obwohl Du selbst nicht Mitglied dieser Gruppe bist. Der Zugriff wurde daher verweigert. Wende Dich bitte an den Systemadministrator wenn Du der Meinung bist, dass das ein Fehler wï¿½re.',
    ...
    'canteditgroup' => 'Um diese Gruppe bearbeiten zu kï¿½nnen, musst Du selbst ein Mitglied der Gruppe sein. Wende Dich bitte an den Systemadministrator wenn Du der Meinung bist, dass das ein Fehler wï¿½re.',
    'cantlistgroup' => 'Um die Mitglieder dieser Gruppe sehen zu kï¿½nnen, musst Du selbst ein Mitglied der Gruppe sein. Wende Dich bitte an den Systemadministrator wenn Du der Meinung bist, dass das ein Fehler wï¿½re.',
...
$LANG_404 = array(
    ...
    3 => "<p>Sorry, diese Seite oder Datei existiert nicht. Du kï¿½nntest es auf der <a href=\"{$_CONF['site_url']}\">Startseite</a> oder mit der <a href=\"{$_CONF['site_url']}/search.php\">Suchfunktion</a> probieren, vielleicht wirst Du ja fï¿½ndig ...",
...
$LANG_TRB = array(
    ...
    'autodetect_failed' => 'Geeklog konnte keine Trackback-URL fï¿½r den Beitrag finden, zu dem der Kommentar gesendet werden sollte. Bitte gib die Trackback-URL von Hand ein.',
    'trackback_explain' => 'Aus den unten aufgefï¿½hrten Links kannst Du jetzt den Beitrag auswï¿½hlen, zu dem Dein Kommentar gesendet werden soll. Geeklog wird versuchen, die Trackback-URL selbst zu ermitteln. Andernfalls kannst Du die Trackback-URL aber auch <a href="%s">von Hand eingeben</a>.',
    ...
    'service_explain' => 'Um ein Weblog-Verzeichnis zu ï¿½ndern oder zu lï¿½schen, auf das ï¿½ndern-Icon klicken. Um ein neues Weblog-Verzeichnis einzutragen, auf Neu anlegen (s.o.) klicken.',
    'service' => 'Verzeichnis',
    ...
    'editor_intro' => 'Hier kannst Du Deinen Trackback-Kommentar fï¿½r <a href="%s">%s</a> eingeben.',
    'editor_intro_none' => 'Trackback-Kommentar eingeben.',
    'trackback_note' => 'Um einen Trackback-Kommentar fï¿½r einen Artikel zu verschicken, benutze bitte den "Ping"-Eintrag in der Liste der Artikel. Um einen Trackback unabhï¿½ngig von einem Artikel zu verschicken, bitte <a href="%s">hier klicken</a>.',
    ...
    'pingback_note' => 'Um einen Pingback fï¿½r einen Artikel zu verschicken, benutze bitte den "Ping"-Eintrag in der Liste der Artikel. Um einen Pingback unabhï¿½ngig von einem Artikel zu verschicken, bitte <a href="%s">hier klicken</a>.',
...
$LANG_ADMIN = array(
    ...
    'reauth_msg' => 'Das Security-Token fï¿½r diese Verï¿½nderung ist ausgelaufen. Wenn Du weitermachen willst, dann bitte unten neu authentifizieren. Damit wird sichergestellt, dass die gerade gemachten ï¿½nderungen nicht verloren gehen.',
