...
$LANG_ACCESS = array(
    ...
    'eventdenialmsg' => 'vous n\'avez pas accès à cet évènement. Peut-être que vous n\'êtes pas membre de .  Vous pouvez <a href=users.php?mode=new>vous enregistrer</a> sur  pour obtenir un compte utilisateur!',
