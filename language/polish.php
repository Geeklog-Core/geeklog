...
$LANG01 = array(
    ...
    57 => 'Has�o',
    58 => 'Login',
    59 => "Nie masz jeszcze konta? Za�� sobie <a href=\"{$_CONF['site_url']}/users.php?mode=new\" rel=\"nofollow\">Nowy U�ytkownik</a>",
    60 => 'Komentarze',
    61 => 'Za�� Konto',
    62 => 's��w',
    ...
    115 => 'Brak nowych powiadomie� zwrotnych dla komentarzy',
    116 => 'Powiadomienia zwrotne',
    117 => 'Katalog',
    118 => 'Dalszy ci�g na kolejnej stronie:',
    119 => "Nie pami�tasz <a href=\"{$_CONF['site_url']}/users.php?mode=getpassword\" rel=\"nofollow\">has�a</a>?",
    120 => 'Sta�y odno�nik do tego komentarza',
    121 => 'Komentarze (%d)',
    122 => 'Powiadomienia zwrotne (%d)',
    123 => 'Wszystkie znaczniki HTML s� dozwolone',
    124 => 'Kliknij aby usun�� wszystkie zaznaczone pozycje',
    125 => 'Czy aby na pewno chcesz Usun�� wszystkie zaznaczone pozycje?',
...
$LANG04 = array(
    ...
    13 => 'Dzienne Zestawienie Artyku��w',
    ...
    66 => "By� mo�e login zosta� b��dnie wpisany.  Spr�buj zalogowa� si� ponownie. Czy jeste� <a href=\"{$_CONF['site_url']}/users.php?mode=new\" rel=\"nofollow\">nowym u�ytkownikiem</a>?",
    67 => 'Cz�onkowstwo Od',
    ...
    71 => "Jedn� z extra mo�liwo�ci serwisu {$_CONF['site_name']} jest mo�liwo�� dopasowania zawarto�ci i wygl�du strony.  Aby skorzysta� z tych udogodnie� nale�y si� najpierw <a href=\"{$_CONF['site_url']}/users.php?mode=new\" rel=\"nofollow\">zarejestrowa�</a> w serwisie {$_CONF['site_name']}.  Jeste� ju� cz�onkiem?  Zaloguj si�!",
    72 => 'Pulpit',
    73 => 'J�zyk',
    ...
    110 => 'Obecne Has�o',
    111 => 'Prosz� wpisa� swoje Obecne has�o',
    112 => 'You have exceeded the number of allowed login attempts.  Please try again later.',
    113 => 'Nieudana Pr�ba Zalogowania',
    114 => 'Konto WY��czone',
    115 => 'Twoje konto zosta�o wy��czone, nie mo�na si� zalogowa�. Prosz� skontaktowa� si� z Administratorem.',
    116 => 'Konto Czeka Na Aktywacj�',
    117 => 'Twoje konto czeka obecnie na aktywacj� przez administratora. You will not be able to login until your account has been approved.',
    118 => "Your {$_CONF['site_name']} account has now been activated by an administrator. You may now login to the site at the url below using your username (<username>) and password as previously emailed to you.",
    119 => 'Je�li nie pami�tasz swojego has�a, kliknij na ten odno�nik aby otrzyma� nowe:',
    120 => 'Konto Zosta�o Aktywowane',
    121 => 'Service',
    122 => 'Przepraszamy, rejestracja nowych u�ytkownik�w jest wy��czona',
    123 => "Czy jeste� <a href=\"{$_CONF['site_url']}/users.php?mode=new\" rel=\"nofollow\">nowym u�ytkownikiem</a>?",
    124 => 'Potwierdzenie Adresu Email',
    125 => 'W obu polach nale�y wpisa� taki sam adres email!',
    126 => 'Please repeat for confirmation',
    127 => 'Aby zmieni� kt�rekolwiek z tych ustawie�, musisz poda� swoje bie��ce has�o.',
    128 => 'Twoje Imi�',
    129 => 'Has�o &amp; Email',
    130 => 'O Sobie',
    ...
    136 => 'Nie Pokazuj Temat�w i Autor�w',
    137 => 'Filtruj Zawarto�� Artyku��w',
    138 => 'Ustawienia R�ne',
    139 => 'Layout i J�zyk',
    ...
    143 => 'Filtruj Zawarto�� Blok�w',
    144 => 'Poka� & ukryj pola',
    145 => 'Tw�j Profil Publiczny',
    146 => 'Has�o i email',
    ...
    157 => 'Delete Option',
    158 => 'Strefa Czasowa',
    159 => 'Ta wiadomo�� zosta�a wygenerowana automatycznie. Prosz� nie odpowiada�.',
...
$LANG10 = array(
    ...
    25 => '10 Najcz�ciej Komentowanych Zwrotnie Artyku��w',
    26 => 'Brak komentarzy zwrotnych.',
    27 => 'Liczba aktywnych u�ytkownik�w',
    28 => '',
    29 => '',
    30 => 'Ods�on',
    31 => '',
...
$LANG20 = array(
    ...
    4 => 'Login:',
    5 => 'Has�o:',
    6 => 'Wszelkie pr�by wej�cia do segment�w administracyjnych s� logowane i weryfikowane.<br' . XHTML . '>Dost�p tylko dla os�b upowa�nionych.',
    7 => 'login',
    8 => 'Login',
...
$LANG21 = array(
    ...
    61 => 'Brak Tytu�u',
    62 => 'Limit Artyku��w',
    63 => 'Nieprawid��wy Tytu� Bloku',
    64 => 'Pole Tytu� nie mo�e by� puste i nie mo�e zawiera� znacznik�w HTML!',
    65 => 'Sorotwanie',
    66 => 'Autotagi',
    67 => 'Zaznacz aby w��czy� autotagi',
...
$LANG24 = array(
    ...
    26 => 'Podgl�d Artyku�u',
    27 => 'Je�li u�ywasz [unscaledX] zamiast [imageX], zdj�cie zostanie zamieszczone w oryginalnym rozmiarze.',
    28 => '<p><b>PODGL�D</b>: Podgl�d artyku�u z za��czonymi zdj�ciami dzia�a najlepiej po uprzednim zapisaniu artyku�u jako kopia robocza ZAMIAST klikaniu na przycisk podgl�du.  Przycisk podgl�du najlepiej u�ywa� gdy nie za��czamy zdj��.',
    29 => 'Trackbacks',
    ...
    39 => 'Emaile',
    40 => '',
    41 => "Pr�bujesz wyedytowa� artyku� do kt�rego nie masz uprawnie�.  Ta pr�ba zosta�a zapisana w logu.  Mo�esz podgl�dn�� artyku� poni�ej. Prosz� <a href=\"{$_CONF['site_admin_url']}/article.php\">wr�ci� do strony administruj�cej artyku�ami.",
    42 => "Pr�bujesz wyedytowa� artyku� do kt�rego nie masz uprawnie�.  Ta pr�ba zosta�a zapisana w logu.  Prosz� <a href=\"{$_CONF['site_admin_url']}/article.php\">wr�ci� do strony administruj�cej artyku�ami</a>.",
    43 => '',
    44 => '',
    45 => '',
    ...
    77 => 'Edytor Zaawansowany wymaga w��czenia Javascript-u. Opcja mo�e zosta� wy��czona w g��wnym pliku config.php',
    78 => 'Kliknij <a href="%s/article.php?mode=edit&amp;sid=%s&amp;editopt=default">tutaj</a> aby w��czy� edytor domy�lny',
    79 => 'Podgl�d',
    80 => 'Edytor',
    81 => 'Opcje Publikacji',
    82 => 'Zdj�cia',
...
$LANG32 = array(
    ...
    9 => 'Ten plugin wymaga nowszej wersji Geekloga. Albo uaktualnij swoj� kopi� <a href="https://www.geeklog.net">Geekloga</a> albo �ci�gnij nowsz� wersj� tego pluginu.',
    10 => '<br' . XHTML . '><b>Brak zainstalowanych plugin�w.</b><br' . XHTML . '><br' . XHTML . '>',
...
$LANG_ACCESS = array(
    ...
    'storydenialmsg' => "Brak dost�pu do tego artyku�u.  Prawdopodobnie nie jeste� cz�onkiem serwisu {$_CONF['site_name']}.  Zapraszamy do <a href=\"{$_CONF['site_url']}/users.php?mode=new\" rel=\"nofollow\"> cz�onkostwa</a> w serwisie {$_CONF['site_name']} aby otrzyma� pe�ny dost�p!",
...
$LANG_confignames['Core'] = array(
    ...
    'disable_new_user_registration' => 'Wy��cz rejestracj� nowych u�ytkownik�w',
    ...
    'submitloginrequired' => 'Wymagane zalogowanie do przes�ania materia��w?',
    ...
    'syndication_max_headlines' => 'Maks. liczba tytu��w (bloki portalowe)',
...
$LANG_configselects['Core'] = array(
    ...
    2 => array('Odrzu�' => 0, 'Tylko Najnowsze' => 1, 'Zezwalaj na Wiele Post�w' => 2),
    ...
    9 => array('Id� do strony' => 'item', 'Poka� list�' => 'list', 'Poka� stron� g��wn�' => 'home', 'Poka� panel sterowania' => 'admin'),
    ...
    13 => array('Pomi�' => 0, 'Allow, with speedlimit' => 1, 'Allow, no speedlimit' => 2),
