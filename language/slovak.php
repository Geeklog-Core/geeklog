...
$LANG01 = array(
    ...
    18 => 'SQL Query',
    19 => 'Odhl�si�',
    20 => 'U��vate�sk� inform�cie:',
    21 => 'U��vate�sk� meno',
    22 => 'U��vate�sk� ID',
    23 => '�rove� bezpe�nosti',
    24 => 'Anonymn� u��vate�',
    25 => 'Odpoveda�',
    26 => 'Nasleduj�ce koment�re s� vlastn�ctvom t�ch, ktor� ich nap�sali. Tento port�l nie je zodpovedn� za to, �o hovoria.',
    ...
    32 => 'Chyba, zl� meno',
    33 => 'Chyba, nepovolen� z�pis do log s�boru',
    34 => 'Chyba',
    35 => 'Odhl�senie',
    36 => ' - ',
    37 => '�iadne �l�nky',
    ...
    57 => 'Heslo',
    58 => 'Login',
    59 => "E�te nem�te konto?  Prihl�ste sa ako <a href=\"{$_CONF['site_url']}/users.php?mode=new\" rel=\"nofollow\">nov� u��vate�</a>.",
    60 => 'Odosla� koment�r',
    61 => 'Vytvori� nov� konto',
    62 => 'slov',
    63 => 'Nastavenie koment�rov',
    64 => 'Posla� �l�nok mailom',
    65 => 'Zobrazi� verziu pre tla�',
    66 => '',
    67 => 'Vitajte na',
    68 => 'Domov',
    69 => 'Kontakt',
    ...
    73 => '',
    74 => '',
    75 => 'Podrobnej�ie vyh�ad�vanie',
    76 => '�tatistiky str�nok',
    77 => 'Z�suvn� moduly',
    78 => '',
    79 => 'Novinky',
    80 => '�l�nky v posledn�ch',
    81 => '�l�nok v poslednom',
    82 => 'hodin�ch',
    83 => 'Koment�re',
    84 => '',
    85 => 'do 48 hod',
    86 => '�iadne nov� koment�re',
    87 => 'do 2 t��d�ov',
    88 => '',
    89 => '',
    90 => 'Hlavn� str�nka',
    ...
    111 => '',
    112 => 'Registrovan� u��vatelia',
    113 => 'Dokument�cia',
    114 => 'Trackbacks',
    115 => 'No new trackback comments',
    116 => 'Trackback',
    117 => 'Arch�v �l�nkov',
    118 => 'Pokra�ujte ��tan�m na �al�ej strane:',
    119 => "Zabudli ste <a href=\"{$_CONF['site_url']}/users.php?mode=getpassword\" rel=\"nofollow\">heslo</a>?",
    120 => 'Trval� odkaz na tento koment�r',
    121 => 'Odkazy (%d)',
    122 => 'Trackbacks (%d)',
    123 => 'Povolen� je �ubovo�n� HTML k�d',
    124 => 'Kliknite pre vymazanie v�etk�ch vyzna�en�ch polo�iek',
    125 => 'Naozaj chcete vymaza� v�etky vyzna�en� polo�ky?',
    126 => 'Ozna�i� alebo odzna�i�',
    127 => 'Trval� odkaz',
    128 => 'Prihl�si� sa s OpenID:',
    129 => 'Konfigur�cia',
    130 => 'Web slu�by',
...
$LANG03 = array(
    ...
    7 => 'V� posledn� koment�r bol pred ',
    8 => " sekundami.  Tento port�l vy�aduje aspo� {$_CONF['commentspeedlimit']} sek�nd medzi koment�rmi",
    9 => 'Koment�r',
    10 => 'Odosla� spr�vu',
    11 => 'Odosla� koment�r',
    12 => 'Pros�m vypl�te nadpis a/alebo samotn� koment�r. Je to nutn�, ak chcete koment�r odosla�.',
    13 => 'Va�e �daje',
    14 => 'N�h�ad',
    15 => 'Nahl�si� tento pr�spevok',
    16 => 'Nadpis',
    17 => 'Chyba',
    18 => 'D�le�it�',
    19 => 'Treba sa dr�a� t�my.',
    20 => 'Je lep�ie odpoveda� na konkr�tny koment�r, ako za��na� dal�ie vl�kno.',
    21 => 'Pre��ta� si pr�spevky ostatn�ch, aby sa koment�re neopakovali.',
    22 => 'Pou�i� jasn� nadpis, ktor� hovor� o koment�ri.',
    23 => 'V� e-mail NEBUDE zobrazen�',
    ...
    24 => 'Anonymn� u��vate�',
    25 => 'Naozaj chcete posla� ozn�menie o tomto koment�ri administr�torovi port�lu?',
    26 => '%s ozn�mil nasledovn� nevhodn� koment�r:',
    27 => 'Spr�va o nevhodn�ch koment�roch',
    28 => 'N�h�ad zmien',
    29 => 'Odosla� zmeny',
    30 => 'Upravovan�',
    31 => 'autor:',
    ...
    36 => 'Ozn�mi� mi nov� koment�re',
    37 => 'Nov� odpove� na koment�r',
    38 => 'Na v� koment�r pri�la odpove� \'%s\'.',
    39 => 'M��ete si prezrie� cel� vl�kno koment�rov na nasledovnej adrese:',
    40 => 'Ak si ne�el�te prij�ma� �al�ie ozn�menia o odpovediach, nav��vte nasledovn� odkaz:',
    41 => 'Vitajte %s,',
    42 => 'Presta� odobera� pr�spevky',
...
$LANG04 = array(
    ...
    21 => 'Error',
    22 => "Vytvorenie pr�stupu pre {$_CONF['site_name']}",
    23 => 'Vytvoren�m konta m�te mo�nos� p�sa� koment�re a prispieva� �l�nkami pod svoj�m menom. Pokia� si pr�stup nevytvor�te, budete ma� obmedzen� anonymn� pr�stup. V� e-mail nebude <b><i>nikdy</i></b> zobrazovan�.',
    24 => 'Heslo V�m bude zaslan� na e-mailov� adresu, ktor� zad�te.',
    25 => 'Zabudli ste svoje heslo?',
    26 => 'Zadajte Va�e prihlasovacie meno a kliknite na odosla� heslo. Bude V�m na Va�u nastaven� e-mailov� adresu zaslan� heslo.',
    27 => 'Vytvori� konto',
    28 => 'Odosla� heslo',
    29 => 'odhl�senie z',
    30 => 'prihl�senie z',
    31 => 'T�to akcia vy�aduje prihl�senie',
    32 => 'Podpis',
    33 => 'Verejne sa nezobrazuje',
    34 => 'Va�e skuto�n� meno',
    35 => 'Pri zmene hesla tu zada� nov� heslo',
    36 => 'Mus� za��na� s http://',
    37 => 'Pou�ije sa pre koment�re',
    38 => '�al�ie verejn� inform�cie o V�s',
    39 => 'V� verejn� PGP k���',
    40 => '�iadne ikony t�m',
    41 => 'Willing to Moderate',
    42 => 'Form�t d�tumu',
    43 => 'Maximum pr�spevkov',
    44 => 'Bez st�pcov',
    45 => 'Nastavenie zobrazovania pre',
    46 => 'Vynechan� polo�ky pre',
    47 => 'Konfigur�cia boxov na pravej strane pre',
    48 => 'T�my',
    ...
    54 => 'Ozna�i� t�my a autorov, ktor�ch nechcete vidie�.',
    55 => 'Ak nech� v�etko neozna�en�, znamen� to, �e chce� �tandardn� nastavenie. Ak u� za�ne� ozna�ova�, ozna� naozaj v�etko, co chce�. �tandardn� nastavenie bude ignorova�. �tandardn� polo�ky s� <strong>tu�n�</strong>.',
    56 => 'Autori',
    57 => 'M�d zobrazenia',
    58 => 'Poradie triedenia',
    59 => 'Limit na po�et koment�rov',
    60 => 'Ako zobrazova� koment�re?',
    61 => 'Od najnov��ch alebo od najstar��ch?',
    62 => '�tandard je 100',
    63 => "Bolo V�m zaslan� heslo e-mailom a malo by k V�m v kr�tkom �ase pr�s�. Pros�me n�sledujte in�trukcie v e-maili. �akujeme V�m za prihl�senie do {$_CONF['site_name']}.",
    64 => 'Nastavenie koment�rov pre',
    65 => 'Sk�ste sa prihl�si� znovu',
    66 => "Nespr�vne prihlasovacie �daje. Pros�m sk�ste op�tovn� prihl�senie ni��ie. Alebo ste <a href=\"{$_CONF['site_url']}/users.php?mode=new\" rel=\"nofollow\">nov� u��vate�</a>?",
    67 => '�len od',
    68 => 'Pam�ta� prihl�senie',
    69 => 'Ako dlho si m� str�nka pam�ta� prihl�senie?',
    ...
    77 => 'Fotografia',
    78 => 'Prida� fotografiu alebo obr�zok.',
    79 => 'Za�krtn�� pre vymazanie tohto obr�zku.',
    80 => 'Prihl�senie',
    81 => 'Posla� mail',
    ...
    100 => 'Maily od administr�tora',
    101 => 'Allow email from Site Admins',
    102 => 'Maily od u��vate�ov',
    103 => 'Allow email from other users',
    104 => 'Zobrazova� online status',
    105 => 'Show up in Who\'s Online block',
    106 => 'Miesto',
    107 => 'Zobrazen� vo verejnom profile',
    108 => 'Potvrdi� nov� heslo',
    109 => 'Tu e�te raz potvrdi� nov� heslo',
    110 => 'Doteraj�ie heslo',
    111 => 'Tu zada� doteraj�ie heslo do syst�mu',
    ...
    124 => 'Zopakova� e-mail',
    125 => 'Mus�te zada� rovnak� e-mailov� adresu v oboch pol��kach!',
    126 => 'Zopakujte pre potvrdenie',
    127 => 'Pre �ubovo�n� zmenu t�chto nastaven� budete potrebova� zada� svoje heslo.',
    128 => 'Meno',
    129 => 'Heslo a mail',
    130 => 'O mne',
    131 => 'Daily Digest Options',
    132 => 'Daily Digest Feature',
    133 => 'Zobrazenie koment�rov',
    134 => 'Mo�nosti koment�rov',
    ...
    136 => 'Skr�va� t�my a autorov',
    137 => 'Filter Article Content',
    138 => 'Rozli�n� nastavenia',
...
$LANG09 = array(
    ...
    17 => 'D�tum',
    18 => 'Autor',
    19 => "Preh�ad�vanie celej datab�zy {$_CONF['site_name']} v aktu�lnych a star��ch �l�nkoch",
    20 => 'D�tum',
    21 => 'do',
    ...
    43 => 'presn� text',
    44 => 'v�etky tieto slov�',
    45 => '�ubovo�n� z t�chto slov',
    46 => '�al��',
    47 => 'Predo�l�',
    48 => 'Autor',
    49 => 'D�tum',
    ...
    59 => 'V�sledky',
    60 => 'na stranu',
    61 => 'Spresni� vyh�ad�vanie',
    62 => '#',
    63 => 'Description',
    64 => 'Zobrazuj� sa v�sledky %1$d - %2$d z %3$d',
    65 => 'Article',
    66 => 'Comment',
    67 => 'Show %d Results',
    68 => 'Sort By',
...
$LANG10 = array(
    ...
    8 => 'Nadpis',
    9 => 'Zobrazenia',
    10 => 'Zd� sa, �e na port�li nie s� �iadne �l�nky alebo ich nikto ne��ta.',
    11 => 'Najkomentovanej�ie �l�nky',
    12 => 'Koment�rov',
    13 => 'Zd� sa, �e na port�li nie s� �iadne �l�nky alebo ich nikto nekomentuje.',
    14 => '',
    15 => '',
    16 => '',
    17 => '',
...
$MESSAGE = array(
    1 => "Va�e prihlasovacie heslo V�m bolo zaslan� na zadan� adresu. Pros�m ria�te sa in�trukciami v maili. �akujeme V�m za na port�li {$_CONF['site_name']}",
    ...
    8 => 'Boli ste �spe�ne odhl�sen�.',
    9 => '�l�nok bol �spe�ne ulo�en�.',
    10 => '�l�nok bol �spe�ne zmazan�.',
    ...
    15 => 'Webov� odkaz bol �spe�ne ulozen�.',
    16 => 'Webov� odkaz bol �spe�ne zmazan�.',
...
$LANG_ACCESS = array(
    ...
    'members' => '�lenovia',
    'anonymous' => 'Anonymn�',
    'permissions' => 'Pr�stupov� pr�va',
    'permissionskey' => 'R = ��ta�, E = upravi�, pr�vo na �pravu zah��a pr�vo ��ta�',
    'edit' => 'Edit',
    'none' => 'None',
...
$LANG_404 = array(
    1 => 'Chyba 404 (str�nka neexistuje)',
...
$LANG_DIR = array(
    'title' => 'Arch�v �l�nkov',
    'title_year' => 'Arch�v �l�nkov pre %d',
    'title_month_year' => 'Arch�v �l�nkov pre %s %d',
    'nav_top' => 'Nasp� na arch�v �l�nkov',
    'no_articles' => '�iadne �l�nky.'
);
...
$LANG_WHATSNEW = array(
    'new_string' => '%n nov�ch %i za posledn�ch %t %s',
    'new_last' => 'za %t posledn�ch %s',
    'minutes' => 'min�t',
    'hours' => 'hod�n',
    'days' => 'dn�',
    'weeks' => 't��d�ov',
...
$LANG_frontpagecodes = array(
    0 => 'Zobrazi� iba v t�me',
    1 => 'Zobrazi� na titulnej str�nke'
);
