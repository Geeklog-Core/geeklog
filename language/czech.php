...
$LANG01 = array(
    ...
    24 => 'Anonymn� host',
    25 => 'Odpov��',
    26 => ' N�sleduj�c� koment��e jsou n�zorem jejich vkladatele. <br' . XHTML . '>Weblog neru�� za to co je zde naps�no.',
    ...
    57 => 'Heslo',
    58 => 'P�ihl�sit',
    59 => "Nem�te zat�m ��et?  P�ihla�te se jako <a href=\"{$_CONF['site_url']}/users.php?mode=new\" rel=\"nofollow\"><b>Nov�&nbsp;u�ivatel</b></a>",
    60 => 'Okomentovat',
    61 => 'Nov� u�ivatel',
    62 => 'slov',
    63 => 'Nastaven� koment���',
...
$LANG04 = array(
    ...
    23 => "Anonymn� u�ivatel� - Host� nemohou nap��klad komentovat �i p�id�vat �l�nky.<br" . XHTML . ">Vytvo�en� ��tu V�m umo�n� vyu��vat v�ech funkc� na {$_CONF['site_name']}. <br" . XHTML . ">Va�e emailov� adresa nebude <b><i>nikdy a nikde</i></b> zve�ejn�na na t�chto str�nk�ch.",
    ...
    66 => "Spletl jste se v zad�n�.  Pros�m zkuste to znovu. Nebo jste  <a href=\"{$_CONF['site_url']}/users.php?mode=new\" rel=\"nofollow\"><b>nov� u�ivatel</b></a>?",
    67 => 'U�ivatelem od',
    68 => 'Pamatovat si mne',
    ...
    71 => "P�izp�soben� vzhledu na {$_CONF['site_name']} v�m umo�n� nastavit si vlastn� vzhled a �azen� polo�ek nez�visle na nastaven� pro hosty.  Pro tato nastaven� se mus�te <a href=\"{$_CONF['site_url']}/users.php?mode=new\" rel=\"nofollow\">p�ihl�sit</a> na {$_CONF['site_name']}. <br" . XHTML . "> Jste u�ivatelem?  Pak pou�ijte p�ihla�ovac� formul�� vlevo!",
    72 => 'Grafick� t�ma',
    73 => 'Jazyk',
...
$LANG08 = array(
    ...
    13 => 'Hlavi�ka:',
    14 => 'Zpr�va:',
    15 => 'Pou�it� HTML tagy nebudou zm�n�ny.<br' . XHTML . '>',
    16 => 'Poslat zpr�vu',
    ...
    25 => 'Mus�te b�t p�ihl�en jako u�ivatel pro pou�it� t�to funkce weblogu.<br' . XHTML . '>  Touto restrikc� se p�edch�z� zneu�it� syst�mu k spammingu!',
...
$LANG20 = array(
    ...
    4 => 'U�ivatel:',
    5 => 'Heslo:',
    6 => 'Ka�d� p��stup do administr�torsk� ��sti str�nek je zapisov�n do log_file a je tam tak� kontrolov�n.<br' . XHTML . '>Tato str�nka je jen pro autorizovan� u�ivatele s administr�torsk�mi pr�vy.',
    7 => 'P�ihl�sit',
    8 => 'Login',
...
$LANG24 = array(
    ...
    39 => 'Posl�no emailem',
    40 => '',
    41 => "Pokou��te se editovat odkaz na n�j� nem�te dostate�n� pr�va.  Tento pokus byl zaznamen�n.  M��ete si jen prohl�dnout �l�nky n�e. Pros�m <a href=\"{$_CONF['site_admin_url']}/article.php\">vra�te se na administraci �l�nk�</a> kdy� skon��te.",
    42 => "Pokou��te se editovat odkaz na n�j� nem�te dostate�n� pr�va.  Tento pokus byl zaznamen�n.  Pros�m <a href=\"{$_CONF['site_admin_url']}/article.php\">vra�te se na administraci �l�nk�</a>.",
    43 => '',
    44 => '',
    45 => '',
    ...
    49 => 'vpravo',
    50 => 'vlevo',
    51 => 'k p�id�n� obr�zk� (max. velikost 200x200px) do �l�nku mus�te vlo�it speci�ln� form�tovan� text.<br' . XHTML . '>Tento text vypad� takto: [imageX](syst�m um�st� s�m), [imageX_right](syst�m um�st� vpravo od textu) nebo [imageX_left](syst�m um�st� vlevo od textu) - kde X je ��slo obr�zku je� je p�id�v�n.<br' . XHTML . '>PAMATUJTE: mus�te pou��t obr�zky je� jsou p�id�v�ny.  V opa�n�m p��pad� nebude mo�no publikovat �l�nek.<BR><P><B>N�HLED</B>: Pro n�hled �l�nku s obr�zky je nejl�pe pou��t n�hled Verze pro tisk�rnu.  Tla��tko <i>n�hled</i> pros�m pou��vejte jen pro prohl�en� �l�nk� bez obr�zk�.',
    52 => '',
