...
$LANG04 = array(
    ...
    140 => '<li>No Topic Icons if checked will not display the article topic icons</li><li>No boxes if checked will only show the Admin Menu, User Menu and Topics<li>Set the maximum number of articles to show per page</li><li>Set your theme and perferred date format</li>',
...
$LANG05 = array(
    ...
    2 => 'There are no news articles to display.  There may be no news for this topic or your user preferences may be too restrictive',
    3 => '',
...
$LANG24 = array(
    ...
    21 => 'Send Ping',
    22 => 'Article List',
    23 => 'To modify or delete an article, click on that article\'s number below. To view an article, click on the title of the article you wish to view. To create a new article click on new article above.',
    ...
    44 => '',
    45 => '',
    46 => '<b>NOTE:</b> if you modify this date to be in the future, this article will not be published until that date.  That also means the article will not be included in your RDF headline feed and it will be ignored by the search and statistics pages.',
    47 => 'Obrázky',
    48 => 'image',
    49 => 'right',
    50 => 'left',
    51 => 'To add one of the images you are attaching to this article you need to insert specially formatted text.  The specially formatted text is [imageX], [imageX_right] or [imageX_left] where X is the number of the image you have attached.  NOTE: You must use the images you attach.  If you do not you will be unable to save your article.<BR><P><B>PREVIEWING</B>: Previewing an article with images attached is best done by saving the article as a draft INSTEAD OF hitting the preview button.  Use the preview button only when images are not attached.',
    52 => '',
...
$LANG27 = array(
    ...
    4 => 'Topic Image',
    5 => '(do not use spaces)',
    6 => 'Deleting a topic deletes all articles and blocks associated with it',
    ...
    21 => 'zmazať',
    22 => 'Default',
    23 => 'make this the default topic for new article submissions',
    24 => '(*)',
    25 => 'Archive Topic',
...
$LANG32 = array(
    ...
    9 => 'This plugin requires a newer version of Geeklog. Either upgrade your copy of <a href="https://www.geeklog.net">Geeklog</a> or get a newer version of the plug-in.',
...
$MESSAGE = array(
    ...
    14 => 'The topic and all it\'s articles an blocks have been successfully deleted.',
