...
$LANG01 = array(
	...
	59 => "¿No tienes una cuenta todavía? <a href=\"{$_CONF['site_url']}/users.php?mode=new\">Regístrate</a>",
...
$LANG03 = array(
	...
	20 => 'Intente responder a los commentarios de los demás en lugar de comenzar una nueva discusión.',
...
$LANG04 = array(
	...
	76 => "Si selecciona una o más Secciones de la lista de abajo, todas las noticias nuevas de esas Secciones le serán enviadas por mail al finalizar el día.",
...
$LANG05 = array(
	...
	2 => "No hay nuevas noticias para mostrar. Puede que no haya novedades para esta Sección o que sus preferencias sean muy restrictivas.",
...
$LANG08 = array(
	...
	23 => "Este email fue enviado a Ud por $from en $fromemail porque pensó que podría interesarle esta Noticia en  {$_CONF["site_url"]}. Esto no es SPAM y los emails involucrados en este envío no fueron guardados para ningún uso posterior.",
...
$LANG10 = array(
	...
	10 => "Parecería que no hay Noticias en este sitio o que nadie jamás las vió.",

	11 => "Las 10 Noticias más comentadas",

	12 => "Comentarios",

	13 => "Parecería que no hay Noticias en este sitio o que nadie jamás escribió un comentario sobre ellas.",
	...
	21 => "Parecería que en este sitio no hay Enlaces o que nadie nuca los visita.",

	22 => "Las 10 Noticias más enviadas por mail",

	23 => "Emails",

	24 => "Parecería que nadie mandó una noticia por mail en este sitio."
...
$LANG23 = array(
	...
	12 => "Para modificar o borrar un Enlace selecciónelo más abajo. Para crear uno nuevo seleccione 'Nuevo Enlace' más arriba.",
	...
	17 => "No tiene permiso para acceder a este Enlace. Todo intento de acceso será registrado. Por favor, vuelva a <a href=\"{$_CONF["site_admin_url"]}/link.php\">la página de Administración de Enlaces</a>.",
...
$LANG24 = array(
	...
	23 => "Para modificar o borrar una Noticia seleccione el número de Noticia más abajo. Para ver la Noticia seleccione el título de la misma. Para crear una nueva Noticia seleccione 'Enviar Noticia' más arriba.",
	...
	41 => "Esta intentando acceder a una Noticia pra la cual no tiene derechos de acceso, por lo que podrá ver la Noticia pero no editarla. Por favor vuelva a la <a href=\"{$_CONF["site_admin_url"]}/story.php\">página de administración</a> cuando haya terminado.",

	42 => "Esta intentando acceder a una Noticia pra la cual no tiene derechos de acceso. Por favor vuelva a la <a href=\"{$_CONF["site_admin_url"]}/story.php\">página de administración</a>.",
	...
	45 => 'Acceso',
        ...
        46 => '<b>NOTA:</b> si modifica esta fecha por una futura, la Noticia no será publicada hasta esa fecha. Esto también incluye el envió de titulares RDF, la búsqueda y las estadísticas del sitio.',
        ...
        51 => 'Para insertar una imagen en la Noticia debe incluir un texto con el formato [imagenX], [imagenX_der] o [imageX_izq], donde X es el número de imagen dentro de la lista. NOTA: sólo puede utilizar las imágenes de la lista, sino la Noticia no podrá ser grabada',
...
$MESSAGE = array (
	...
	2 => "Gracias por enviar su Noticia a {$_CONF["site_name"]}. La Noticia se encuentra en proceso de aprobación. De ser aprobada podrá ser leida por todos los visitantes del sitio.",

	3 => "Gracias por enviar su Enlace a {$_CONF["site_name"]}. El Enlace se encuentra en proceso de aprobación. De ser aprobado podrá ser visto por todos los visitantes del sitio.",
	...
	9 => "Su Noticia ha sido grabada con éxito.",

	10 => "La Noticia ha sido borrada con éxito.",
	...
	14 => "La Sección junto con todas sus Noticias y Bloques ha sido borrado con éxito.",

	15 => "Su enlace fue grabado con éxito.",

	16 => "El enlace fue borrado con éxito.",
	...
	31 => "Disculpe, no tiene acceso a la página de administración de Noticias. Aclaramos que todo acceso sin autorización queda registrado en el servidor.",
	...
	34 => "Disculpe, no tiene acceso a la página de administración de Enlaces. Aclaramos que todo acceso sin autorización queda registrado en el servidor.",
...
$LANG_ACCESS = array(
	...
	storydenialmsg => "No tiene acceso para ver esta Noticia. Esto puede ser porque no es miembro de {$_CONF["site_name"]}. Por favor <a href=users.php?mode=new>conviértase en un miembro</a> de {$_CONF["site_name"]} para tener acceso.",
...
$LANG_404 = array(
    ...
    2 => "Buah, he mirado en todos los lados per no puedo encontrar <b>http://{$HTTP_SERVER_VARS["HTTP_HOST"]}{$HTTP_SERVER_VARS["REQUEST_URI"]}</b>.",
