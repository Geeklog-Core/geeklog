...
$LANG04 = array(
    ...
    140 => '<li>No Topic Icons if checked will not display the article topic icons</li><li>No boxes if checked will only show the Admin Menu, User Menu and Topics<li>Establecer el número máximo de posts a mostrar por página</li><li>Establezca el tema de diseño y el formato de fecha</li>',
...
$LANG32 = array(
    ...
    9 => 'Este Plug-in requiere una versión más nueva de Geeklog. Puedes obtener una copia actualizada de <a href="https://www.geeklog.net">Geeklog</a> o instalar otra versión del Plug-in.',
