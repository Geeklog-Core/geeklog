...
$LANG04 = array(
    ...
    71 => "Ena od posebnosti spletne strani {$_CONF['site_name']} je možnost popolnega prilagajanja izgleda posameznemu uporabniku.  Èe hoèeš uporabiti to možnost, se moraš najprej <a href=\"{$_CONF['site_url']}/users.php?mode=new\">prijaviti</a> na {$_CONF['site_name']}. Si že postal/a registrirani uporabnik? Prijavi se!",
    72 => 'Tema',
    73 => 'Jezik',
...
$LANG_ACCESS = array(
    ...
    'storydenialmsg' => "Žal nimaš dostopa do tega èlanka. Morda zato, ker nisi èlan? <a href=\"{$_CONF['site_url']}/users.php?mode=new\">Postani èlan</a> spletne strani {$_CONF['site_name']} in dobil/a boš popoln dostop.",
...
$LANG_DB_BACKUP = array(
    ...
    'not_found' => "Napaèna pot ali pa orodje mysqldump ni izvršljivo.<br>Preveri definicijo <strong>\$_DB_mysqldump_path</strong> v config.php.<br>Spremenljivka je trenutno definirana kot: <var>{$_DB_mysqldump_path}</var>",
