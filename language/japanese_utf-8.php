...
$LANG04 = array(
    ...
    94 => 'アカウント("%s")を削除',
    95 => 'あなたのアカウントを削除するには、上の「現在のパスワード」にパスワードを入力してから、下の「アカウントの削除オプション」にチェックを入れ、「保存」をクリックしてください。ただし、あなたのアカウント名で投稿した記事やコメントの<strong>削除はしません</strong>。これらの記事やコメントは「ゲストユーザー」の投稿として表示するようになります。',
    96 => 'アカウント削除',
    97 => 'アカウント削除の確認',
