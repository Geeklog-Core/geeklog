...
$LANG31 = array(
    ...
    20 => "<successcount> 件のメッセージの送信に成功し、<failcount> 件のメッセージの送信には失敗しました。個別のメッセージの送信状態は次のとおりです。<a href=\"" . $_CONF['site_url'] . "/admin/mail.php\">別のメッセージを送信</a>するか、<a href=\"" . $_CONF['site_url'] . "/admin/moderation.php\">管理画面に戻る</a>ことが出来ます",
    21 => '件の失敗',
    22 => '件の成功',
    23 => '失敗したものはありません',
    24 => '成功したものはありません',
