...
$LANG08 = array(
    ...
    21 => 'メールアドレス',
    22 => 'すべての項目を入力してください',
    23 => "このメールは，%s さんが{$_CONF['site_url']}の記事をあなたに知らせたいと思ったため，%s のアドレスから送信されました。これはいわゆる迷惑（SPAM）メールではありませんし，送信に使用されたアドレスを他の目的に使用することもありません。",
...
$LANG_TRB = array (
    ...
    'services_headline'  => 'Weblogディレクトリサービス管理',
    'admin_home'         => '管理画面',
    'new_service'        => '新規サービス',
