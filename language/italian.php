...
$LANG04 = array(
	...
	26 => "Inserisci il tuo Nome Utente e clicca su Email Password e una nuova password ti sar&agrave; inviata all'indirizzo registrato nel nostro database.",
	27 => "Registrati Ora!",
	28 => "Email Password",
	29 => "uscito da",
	30 => "entrato in",
...
$LANG24 = array(
	...
	45 => 'Accesso',
    46 => '<b>NOTA:</b> se modifichi questa data postadatandola, questo articolo non sar&agrave; pubblicato fino a suddetta data.  Questo significa inoltre che il articolo non sar&agrave; incluso nel tuo RDF headline feed e verr&agrave; ignorato dalla ricerca e dalle statistiche.',
    47 => 'Immagini',
    48 => 'immagine',
    49 => 'destra',
    50 => 'sinistra',
    51 => 'Per aggiungere una delle immagini in allegato a questo articolo devi inserire del codice di testo speciale.  Questo codice speciale &egrave; [imageX], [imageX_right] o [imageX_left] dove X &egrave; il numero della immagine allegata.  <br>NOTA: Devi utilizzare le immagini allegate.  Altrimenti non sarai in grado di salvare il tuo articolo.<BR><P><B>ANTEPRIMA</B>: La Anteprima di un articolo con immagini allegate risulta pi agevole da realizzare salvandolo come un draft AL POSTO di cliccare sul bottone anteprima.  Usare il bottone anteprima solo con immagini che non sono allegate.',
    52 => 'Elimina',
    53 => 'non &egrave; utilizzata.  Devi includere questa immagine nella intro o nel corpo per poter salvare le tue modifiche',
