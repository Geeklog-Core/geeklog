...
$LANG03 = array(
	...
	20 => 'Prova a rispondere ad un commento di un altro utente anzichè aprire un nuovo inserimento.',
...
$LANG21 = array(
    ...
    29 => "Funzione Blocco",
    30 => "Se desideri avere un blocco che usi il codice PHP, inserisci il nome della funzione sotto.  Il nome della tua funzione deve iniziare con il prefisso \"phpblock_\" (es. phpblock_getweather).  Se non ha questo prefisso, la tua funzione NON verrà richiama.  Questo per evitare che altre persone possano hackerare la vostra installazione di Geeklog inserendo funzioni di chiamate a codice arbitrario che possa danneggiare il vostro sistema.  Assicuratevi di inserire le parentesi vuote \"()\" dopo il vostro nome della funzione.  <br><br>Per ultimo, è raccomandabile mettere tutto il codice del Blocco in /path/to/geeklog/system/lib-custom.php.  <br><b>Questo permette di salvare il tuo codice nel caso di aggiornamenti di Geeklog.</b>",
    ...
    38 => "La funzione per il Blocco PHP deve avere il prefisso 'phpblock_' (es. phpblock_getweather).  Il prefisso 'phpblock_' è richiesto per ragioni di sicurezza in particolare per prevenire le esecuzioni di codice arbitrario.",
	39 => "Lato",
	40 => "Sinistro",
	41 => "Destro",
	...
	43 => "Solo in Homepage",
	44 => "Accesso Negato",
	45 => "Stai tentando di accedere a un blocco del quale non hai i permessi di modifica.  Questo tentativo sarà registrato. Prego <a href=\"{$_CONF["site_admin_url"]}/block.php\">ritorna alla schermata di amministrazione</a>.",
	46 => 'Nuovo Blocco',
	47 => 'Area Amministrazione',
    48 => 'Nome Blocco',
    49 => ' (nessun spazio e deve essere univoco)',
    50 => 'URL File di Help',
    51 => 'includi http://',
    52 => 'Se lasci in bianco questo spazio non verrà visualizzata la icona di Help per questo blocco',
    53 => 'Abilitato',
    54 => 'salva',
    55 => 'cancella',
    56 => 'elimina'
...
$LANG22 = array(
	...
	9 => "(includi http://)",
	10 => "Devi fornire la data/orario, descrizione e località evento!",
	11 => "Lista Eventi",
	12 => "Per modificare o cancellare un evento, clicca sull'evento selezionato sotto.  <br>Per creare un nuovo evento clicca su [ Nuovo Evento ] sopra.",
	13 => "Titolo Evento",
	14 => "Data Inizio",
	15 => "Data Fine",
	16 => "Accesso Negato",
	17 => "Stai tentando di accedere a un evento del quale non hai i permessi di modifica.  Questo tentativo sarà registrato. Prego <a href=\"{$_CONF["site_admin_url"]}/event.php\">ritorna alla schermata di amministrazione</a>.",
	18 => 'Nuovo Evento',
	19 => 'Area Amministrazione',
    20 => 'salva',
    21 => 'cancella',
    22 => 'elimina'
);
...
$LANG23 = array(
	...
	15 => "Link URL",
	16 => "Accesso Negato",
	17 => "Stai tentando di accedere a un link del quale non hai i permessi di modifica.  Questo tentativo sarà registrato. Prego <a href=\"{$_CONF["site_admin_url"]}/link.php\">ritorna alla schermata di amministrazione</a>.",
	18 => 'Nuovo Link',
	19 => 'Area Amministrazione',
...
$LANG24 = array(
	...
	29 => "",
	30 => "",
	31 => "Prego compila i campi di testo Autore, Titolo e Intro",
	32 => "Featured",
	...
	39 => "Emails",
	40 => "Accesso negato",
	41 => "Stai tentando di accedere a un articolo dove non hai i permessi di accesso.  Questo tentativo sarà tracciato.  You may view the article in read-only below. Please <a href=\"{$_CONF["site_admin_url"]}/story.php\">go back to the story administration screen</a> when you are done.",
	42 => "Stai tentando di accedere a un articolo dove non hai i permessi di accesso.  Questo tentativo sarà tracciato.  Please <a href=\"{$_CONF["site_admin_url"]}/story.php\">go back to the story administration screen</a>.",
	43 => 'Nuova Articolo',
	44 => 'Area Amministrazione',
	45 => 'Accesso',
    46 => '<b>NOTA:</b> se modifichi questa data postadatandola, questo articolo non sarà pubblicato fino a suddetta data.  Questo significa inoltre che il articolo non sarà incluso nel tuo RDF headline feed e verrà ignorato dalla ricerca e dalle statistiche.',
    47 => 'Immagini',
    48 => 'immagine',
    49 => 'destra',
    50 => 'sinistra',
    51 => 'Per aggiungere una delle immagini in allegato a questo articolo devi inserire del codice di testo speciale.  Questo codice speciale è [imageX], [imageX_right] o [imageX_left] dove X è il numero della immagine allegata.  <br>NOTA: Devi utilizzare le immagini allegate.  Altrimenti non sarai in grado di salvare il tuo articolo.<BR><P><B>ANTEPRIMA</B>: La Anteprima di un articolo con immagini allegate risulta più agevole da realizzare salvandolo come un draft AL POSTO di cliccare sul bottone anteprima.  Usare il bottone anteprima solo con immagini che non sono allegate.',
    52 => 'Elimina',
    53 => 'non è utilizzata.  Devi includere questa immagine nel intro o nel corpo per poter salvare le tue modifiche',
    54 => 'Immagini in Allegato Non Usate',
    55 => 'Si sono verificati i seguenti errori durante il salvataggio del tuo articoli.  Prego correggi gli errori prima di salvarlo',
...
$LANG25 = array(
	...
	20 => "Voti",
	21 => "Accesso Negato",
	22 => "Stai tentando di accedere a un sondaggio del quale non hai i permessi di modifica.  Questo tentativo sarà registrato. Prego <a href=\"{$_CONF["site_admin_url"]}/poll.php\">ritorna alla schermata amministrazione sondaggi</a>.",
	23 => 'Nuovo Sondaggio',
	24 => 'Area Amministrazione',
	25 => 'Si',
	26 => 'No'
);
...
$LANG27 = array(
	...
	8 => "Manager Argomenti",
	9 => "Per modificare o cancellare un argomento, clicca sull'argomento selezionato.  <br>Per creare un nuovo argomento clicca sul [ Nuovo Argomento ] in alto. <br>Dovresti trovare il tuoi permessi di accesso per ogni argomento elencati fra parentesi.",
	10=> "Ordinamento",
	11 => "Articoli/Pagina",
	12 => "Accesso negato",
...
$LANG28 = array(
	...
	11 => "Manager Utenti",
	12 => "Per modificare o cancellare un utente, clicca su un utente quì sotto.  <br>Per creare un nuovo utente clicca sul bottone [ Nuovo Utente ] in alto. <br>Per eseguire una ricerca semplice inserisci parti di nome utente,indirizzo e-mail o nome completo (es.*son* or *.edu) nel modulo sottostante.",
	13 => "SecLev",
	14 => "Data Reg.",
	15 => 'Nuovo Utente',
    ...
    26 => 'Ricerca',
    27 => 'Risultati limite',
    28 => 'Clicca quì per cancellare questa immagine',
    29 => 'Percorso',
    30 => 'Importa',
    31 => 'Nuovo Utente',
...
$MESSAGE = array (
 ...
 autorizzati vengono registrati.",
    ...
    48 => 'Grazie per la tua richiesta di registrazione a ' .$_CONF['site_name'] . '. Il nostro Team valuterà la tua richiesta. Se approvata ti verrà inviata via posta elettronica la password alla casella email da te specificata.',
...
$LANG_ACCESS = array(
	...
	newgroupmsg => "Per modificare o cancellare un gruppo, selezionalo dalla lista sottostante. <br>Per creare un nuovo gruppo clicca su [ Nuovo Gruppo ] sopra. <br>Considera che il gruppo principale non può essere cancellato in quanto usato dal sistema.",
	...
	cancel => 'cancella',
	delete => 'elimina',
	canteditroot => 'Hai provato a editare il Gruppo Root ma non fai parte del gruppo stesso e quindi la tua modifica non è consentita. Prego contatta gli Amministratori se ritieni questo messaggio un errore'
);
