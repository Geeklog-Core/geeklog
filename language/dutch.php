...
###############################################################################
# dutch.php
# This is the dutch language page for GeekLog!
#
...
$LANG01 = array(
	...
	24 => "Anoniem",
	25 => "Beantwoord",
	26 => "Voor de volgende reacties en/of zijn voor verantwoording van degene die deze plaatst. Deze site is niet verantwoordelijk voor wat deze inhoud(en).",
...
$LANG02 = array(
	...
	8 => "Door dit evenement aan uw kalender toe te voegen, kunt u snel  de evenementen zien waarin u geïnterresseerd bent door op Mijn Kalender te klikken onder Gebruikers Funkties.",
...
$LANG04 = array(
	...
	18 => "Het email adres lijkt geen juist email adres",
	...
	23 => "Door het aanmaken van een gebruiker account profiteerd u van alle voordelen van {$_CONF['site_name']} site lidmaadschap en geeft u de mogelijkheid reacties en artikelen onder uw eigen naam te plaatsen. Indien u niet registreerd, is dit allen anoniem mogelijk. Let op, uw email adres zal <b><i>nooit</i></b> publiekelijk worden weergegeven op deze site.",
	24 => "Uw wachtwoord wordt verstuurd naar het email adres dat u invoerd.",
...
$MESSAGE = array (
	...
	43 => "Het woord is verwijderd.",
      ...
      49 => "Uw groep is opgeslagen.",
      50 => "Uw groep is verwijderd."
);
