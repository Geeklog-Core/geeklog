...
###############################################################################
# hebrew.php # last Update  14/2/2006
# Version 1.4 #1
...
$LANG04 = array(
    ...
    11 => 'אין תגובות',
    12 => 'מאפיני המשתמש של',
    13 => 'שילחו באימייל את המאגר הלילי',
    ...
    95 => 'ליחצו על הכפתור "מחיקת חשבון" שמתחת כדי למחוק את חשבונכם ממאגר הנתונים שלנו. אנא שימו לב שכל המאמרים והתגובות שכתבתם תחת חשבון זה <strong>לא</strong> ימחקו, אלא ייראו כאילו נכתבו על ידי "משתמש אנונימי".',
    96 => 'מחיקת חשבון',
...
$LANG09 = array(
    ...
    34 => 'מיקום',
    35 => 'יום שלם',
    36 => 'לא נמצאו אירועים המתאימים לחיפושכם',
...
$LANG10 = array(
    ...
    25 => 'עשרת המאמרים שקיבלו הכי הרבה הפניות',
    26 => 'לא נמצאו הפניות למאמרים.',
    27 => 'מספר המשתמשים הפעילים',
    28 => 'עשרת האירועים הפופולרייים ביותר',
    29 => 'אירוע',
    30 => 'צפיות',
    31 => 'נראה שאין שום אירועים באתר זה או שאף אחד עוד לא הקיש עליהם.'
);
...
$LANG12 = array(
    ...
    8 => 'שליחה',
    9 => 'בעת שליחת מידע לשימוש באתר אנו מבקשים שתעקבו אחר ההמלצות הבאות...<ul><li>מלאו את כל השדות, הם נדרשים<li>הכניסו מידע מלא ומדויק<li>בידקו טוב את כתובות האתרים</ul>',
    10 => 'כותרת',
    11 => 'קישור',
    12 => 'תאריך התחלה',
    13 => 'תאריך סיום',
    ...
    36 => 'מצב כתיבה',
    37 => "הוספת אירוע ל-{$_CONF['site_name']} תשים אותו ביומן הראשי היכן שמשתמשים רשאים להוסיף אותו ליומנים האישיים שלהם. יכולת זו <b>אינה</b> מיועדת לאחסן את האירועים הפרטיים שלכם כמו ימי הולדת ותזכורות שנתיות.<br><br>ברגע שתפרסמו את האירוע שלכם הוא ישלח למנהלי האתר ואם יאושר, יופיע ביומן הראשי.",
    38 => 'הוספת אירוע ל:',
    39 => 'יומן ראשי',
    40 => 'יומן אישי',
    41 => 'שעת סיום',
...
$LANG21 = array(
    ...
    24 => '',
    25 => 'כדי לשנות או למחוק קוביית מידע, ליחצו על אייקון העריכה שמתחת. כדי ליצור קוביית מידע חדשה, ליחצו על "צרו חדשה" שלעיל. כדי להזיז קוביית מידע, ליחצו על החיצים או על קוביות ה-[R] או ה-[L].',
    26 => 'עיצוב קוביית מידע',
    27 => 'קוביית מידע PHP',
    28 => 'אפשרויות קוביית מידע PHP',
    29 => 'פונקציית קוביית מידע',
    30 => 'אם ברצונכם שאחת מקוביות המידע שלכם תשתמש בקוד PHP, הכניסו לעיל את שם הפונקציה. שם הפונקציה שלכם חייב להתחיל עם התחילית "_phpblock" (לדוגמא, phpblock_getweather). ללא תחילית זו, הפוקנציה שלכם *לא* תפעל. אנו עושים זאת כדי למנוע מאנשים שאולי פרצו להתקנת התוכנה מלהשתמש בקריאות פונקציה שרירותיות שעלולות לפגוע במערכת שלכם. שימו לב לא לשים סוגריים ריקים "()" אחרי שם הפונקציה שלכם. לסיכום, מומלץ שתשימו את כל קוד קוביית המידע PHP שלך בתוך /path/to/geeklog/system/lib-custom.php. דבר זה יאפשר לקוד להישאר איתכם אפילו כאשר הנכם מעדכנים לגירסת תוכנה חדשה יותר.',
    31 => 'טעות בקוביית מידע PHP. הפונקציה, %s, לא קיימת.',
    32 => 'טעות של שדה/ות לא מלא/ים',
    33 => 'הנכם חייבים להכניס קישור לקובץ ה-RSS בשביל קוביות מידע של פורטלים',
    ...
    55 => 'ביטול',
    56 => 'מחיקה',
    58 => 'הזיזו קוביית מידע למטה',
    58 => 'הזיזו קוביית מידע למעלה',
    59 => 'הזיזו קוביית מידע לצד הימני',
    60 => 'הזיזו קוביית מידע לצד השמאלי',
    61 => 'אין כותרת',
...
$LANG22 = array(
    ...
    11 => 'מנהל האירוע',
    12 => ' כדי לשנות או למחוק אירוע, ליחצו על אייקון העריכה שלו מתחת. כדי ליצור אירוע חדש, ליחצו על "צרו חדש" שלעיל. ליחצו על אייקון ההעתקה כדי ליצור עותק של אירוע קיים.',
    13 => 'יוצר',
    14 => 'תאריך התחלה',
    15 => 'תאריך סיום',
    16 => '',
...
$LANG24 = array(
    ...
    21 => 'שילחו פינג',
    22 => 'רשימת מאמרים',
    23 => ' כדי לשנות או למחוק מאמר, ליחצו על אייקון העריכה שלו מתחת. כדי לצפות במאמר, ליחצו על הכותרת של המאמר שאתם מבקשים לצפות בו. שלעיל. כדי ליצור מאמר חדש, ליחצו על "צרו חדש" לעיל.',
    24 => 'קוד הזיהוי שבחרתם למאמר זה כבר נמצא בשימוש. אנא השתמשו בקוד זיהוי אחר.',
    25 => 'שגיאה בעת שמירת המאמר',
    26 => 'תצוגה מקדימה של המאמר',
    27 => 'אם הנכם משתמשים ב-[unscaledX] במקום ב-[imageX], התמונה תוכנס במימדיה המקוריים.',
    28 => '<p><b>תצוגה מקדימה</b>: תצוגה מקדימה של מאמר עם תמונות מצורפות הכי טוב שתיעשה על ידי שמירת המאמר כטיוטא *במקום* ללחוץ על כפתור התצוגה המקדימה. השתמשו בכפתור התצוגה המקדימה רק כאשר אין תמונות מצורפות.',
    29 => 'הפניות',
    ...
    44 => '',
    45 => '',
    46 => '<b>שימו לב:</b> אם תשנו תאריך זה להיות בעתיד, מאמר זה לא יפורסם עד אותו תאריך. משמעות הדבר היא גם שהוא לא ייכלל בהזנת כותרות ה-RSS והוא יזכה להתעלמות מעמודי החיפוש והסטטיסטיקה.',
    47 => 'תמונות',
    48 => 'תמונה',
    49 => 'שמאל',
    50 => 'ימין',
    ...
    75 => 'מוצג במלואו',
    76 => 'אפשרויות פירסום',
    77 => 'Javascript חייב להיות מופעל בעורך המתקדם. האפשרות יכולה להיכבות ב-config.php הראשי של האתר',
...
$LANG28 = array(
    ...
    12 => 'כדי לערוך או למחוק משתמש, ליחצו על אייקון המשתמש שמתחת. כדי לצפות במשתמש, ליחצו עליו. כדי ליצור משתמש חדש, ליחצו על "צרו חדש" שלעיל. הנכם יכולים לבצע חיפושים פשוטים על ידי הכנסת חלק משם המשתמש, כתובת האימייל או השם המלא (לדוגמא *son* או edu.*) בטופס שלהלן.',
    13 => 'רמת אבטחה',
    14 => 'תאריך הרשמה',
    15 => '',
    16 => '',
...
$LANG33 = array(
    ...
    11 => 'הזנה חדשה',
    12 => 'מרכז הניהול',
    13 => 'כדי לערוך או למחוק הזנה, ליחצו על אייקון העריכה שלה מתחת. כדי ליצור הזנה חדשה, ליחצו על "צרו חדש" שלעיל.',
    14 => 'כותרת',
    15 => 'סוג',
    16 => 'שם קובץ',
    17 => 'פורמט',
    ...
    40 => 'אנא הכניסו את מספר הנתונים או את מספר השעות.',
    41 => 'שמירה',
    42 => 'אירועים',
    43 => 'הכל',
    44 => 'כלום',
    45 => 'קישור הכותרת בנושא',
    46 => 'הגבלת תוצאות',
    47 => 'חיפוש',
    48 => 'עריכה',
    49 => 'הלוגו של ההזנה',
...
$MESSAGE = array(
    ...
    25 => 'אי אפשר לפתוח את היומן האישי שלכם עד שתיכנסו למערכת',
    ...
    34 => 'מצטערים, אין לכם גישה לעמוד ניהול הקישורים. אנא שימו לב שכל נסיונות הגישה ליכולות לא מאושרות נרשמים ביומן',
    35 => 'מצטערים, אין לכם גישה לעמוד ניהול האירועים. אנא שימו לב שכל נסיונות הגישה ליכולות לא מאושרות נרשמים ביומן',
    36 => 'מצטערים, אין לכם גישה לעמוד ניהול הסקרים. אנא שימו לב שכל נסיונות הגישה ליכולות לא מאושרות נרשמים ביומן',
    ...
    62 => 'ההפנייה נמחקה.',
    63 => 'אירעה שגיאה בעת מחיקת ההפנייה.',
    64 => 'ההפנייה שלכם נשלחה בהצלחה.',
...
$LANG_ACCESS = array(
    ...
    'newgroupmsg' => 'כדי לערוך או למחוק קבוצה, ליחצו על אייקון העריכה שמתחת. כדי ליצור קבוצה חדשה, ליחצו על קבוצה "צרו חדש" שלעיל. אנא שימו לב שקבוצות גרעין לא יכולות להימחק מפני שהן בשימוש המערכת.',
    'groupname' => 'שם קבוצה',
    ...
    'editgroupmsg' => 'על מנת לשנות את הרישום לקבוצות, ליחצו על שם החבר/ים והשתמשו בכפתורי ההוספה וההורדה. אם החבר הוא חבר באותה קבוצה, שמם יופיע בצד השמאלי בלבד. ברגע שסיימתם - ליחצו על <b>Save</b> כדי לעדכן את הקבוצה ולחזור לעמוד הנהלת הקבוצות הראשי.',
    'listgroupmsg' => 'רשימת כל החברים בקבוצה: <b>%s</b>',
    'search' => 'חיפוש',
    'submit' => 'שליחה',
    'limitresults' => 'הגבלת תוצאות',
    'group_id' => 'קוד זיהוי הקבוצה',
    'plugin_access_denied_msg' => 'הנכם מנסים באופן לא חוקי לגשת לעמוד הנהלת ה-plugins. אנא שימו לב שכל הנסיונות לגשת לעמוד זה באופן לא חוקי נרשמות ביומן.',
...
$LANG_TRB = array(
    ...
    'no_comments' => 'אין הפניות לערך זה.',
    'this_trackback_url' => 'כתובת מפנה לערך זה:',
    'num_comments' => '%d הפניות',
    'send_trackback' => 'שילחו פינגים',
    'preview' => 'תצוגה מקדימה',
    'editor_title' => 'שילחו הפנייה',
    ...
    'send_error' => 'שגיאה',
    'send_error_details' => 'שגיאה בעת שליחת הפנייה:',
    ...
    'trackback_explain' => 'מתוך הקישורים שלהלן, אנא ביחרו את הכתובת שהנכם רוצים לשלוח אליה את תגובתכם. לאחר מכן יהיה נסיון לזהות את כתובת ההפנייה לפירסום זה. או שתוכלו <a href="%s">להכניס זאת ידנית</a> אם אתם כבר יודעים אותה.',
    'no_links_trackback' => 'לא נמצאו קישורים. אינכם יכולים לשלוח הפנייה לטקסט זה.',
    'pingback' => 'פינג חוזר',
    ...
    'service_explain' => 'כדי לשנות או למחוק שירות ספריית בלוגים, ליחצו על אייקון העריכה של אותו שירות להלן. כדי להוסיף שירות ספריית בלוגים חדש, ליחצו על "הוסיפו חדש" לעיל.',
    'service' => 'שירות',
    ...
    'trackbacks' => 'הפניות',
    'editor_intro' => 'הכינו את ההפנייה שלכם עבור <a href="%s">%s</a>.',
    'editor_intro_none' => 'הכינו את ההפנייה שלכם.',
    'trackback_note' => 'כדי לשלוח הפנייה למאמר, לכו לרשימת המאמרים וליחצו על "שליחת פינגים" למאמר זה. כדי לשלוח הפנייה שאינה קשורה למאמר, <a href="%s">ליחצו כאן</a>.',
    ...
    'pingback_note' => 'כדי לשלוח פינג חוזר למאמר, לכו לרשימת המאמרים וליחצו על "שליחת פינגים" למאמר הרצוי. כדי לשלוח פינג חוזר שלא קשור למאמר, <a href="%s">ליחצו כאן</a>.',
...
$LANG_WHATSNEW = array(
    'new_string' => '%n %i חדש/ים ב-%t ה%s האחרונים/ות',
